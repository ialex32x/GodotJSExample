...
export default class Snake extends Node {
  ...
  private accessor _speed: number = 100;
  ...
  _ready() {
    ...
    this._control_node = this.get_node("Control");
    this._score_label = <Label>this.get_node("UI/VBoxContainer/ScoreLabel");
    this._state_label = <Label>this.get_node("UI/VBoxContainer/StateLabel");
    this._speed_label = <Label>this.get_node("UI/VBoxContainer/SpeedLabel");
