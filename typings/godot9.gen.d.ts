...
declare module "godot" {
  ...
  class Transform2D {
    ...
    static MULTIPLY(
      left: Transform2D,
      right: PackedVector2Array | Vector2[],
    ): PackedVector2Array;
    static MULTIPLY(
      left: PackedVector2Array | Vector2[],
      right: Transform2D,
    ): PackedVector2Array;
  ...
  class Transform3D {
    ...
    static MULTIPLY(
      left: Transform3D,
      right: PackedVector3Array | Vector3[],
    ): PackedVector3Array;
    static MULTIPLY(
      left: PackedVector3Array | Vector3[],
      right: Transform3D,
    ): PackedVector3Array;
  ...
  class Projection {
    ...
    static create_perspective_hmd(
      ...
      flip_fov: boolean,
      eye: int64,
      intraocular_dist: float64,
      convergence_dist: float64,
    ): Projection;
    ...
    static create_for_hmd(
      ...
      aspect: float64,
      intraocular_dist: float64,
      display_width: float64,
      display_to_lens: float64,
      oversample: float64,
      z_near: float64,
      z_far: float64,
    ): Projection;
  ...
  class Color {
    ...
    clamp(
      min?: Color /* = new Color(0, 0, 0, 0) */,
      max?: Color /* = new Color(1, 1, 1, 1) */,
    ): Color;
  ...
  class NodePath {
    ...
    static NOT_EQUAL(
      left: NodePath | string,
      right: NodePath | string,
    ): boolean;
  }
  ...
  class Callable<T extends Function = Function> {
     ...
     */
    static create<S extends Object, F extends (this: S, ...args: any[]) => any>(
      self: S,
      fn: F,
    ): Callable<F>;
    constructor();
  ...
  class Signal<T extends (...args: any[]) => void = (...args: any[]) => void> {
    as_promise(): Parameters<T> extends []
      ? Promise<void>
      : Parameters<T> extends [infer R]
        ? Promise<R>
  ...
  class GDictionary<T = Record<any, any>> {
    ...
    static create<V extends { [key: number | string]: GWrappableValue }>(
      properties: V,
    ): GValueWrap<V>;
    static create<V extends GDictionary<any>>(
      properties: V extends GDictionary<infer T>
        ? { [K in keyof T]: GDataStructureCreateValue<T[K]> }
        : never,
    ): V;
    ...
    values(): UndefinedToNull<T[keyof T]> extends GAny
      ? GArray<UndefinedToNull<T[keyof T]>>
      : GArray;
  ...
  class GArray<T extends GAny | GAny[] = GAny | GAny[]> {
    ...
    static create<E extends GAny>(
      elements: Array<GDataStructureCreateValue<E>>,
    ): GArray<E>;
    ...
    sort(): void;
    sort_custom(
      func: Callable<(a: GArrayElement<T>, b: GArrayElement<T>) => boolean>,
    ): void;
    shuffle(): void;
    bsearch(value: GArrayElement<T>, before?: boolean /* = true */): int64;
    bsearch_custom(
      value: GArrayElement<T>,
      func: Callable<(a: GArrayElement<T>, b: GArrayElement<T>) => boolean>,
      before?: boolean /* = true */,
    ): int64;
    reverse(): void;
    ...
    slice(
      begin: int64,
      end?: int64 /* = 2147483647 */,
      step?: int64 /* = 1 */,
      deep?: boolean /* = false */,
    ): GArray<GArrayElement<T>>;
    filter(
      method: Callable<(value: GArrayElement<T>) => boolean>,
    ): GArray<GArrayElement<T>>;
    map<U extends GAny>(
      method: Callable<(value: GArrayElement<T>) => U>,
    ): GArray<U>;
  ...
  class PackedByteArray {
    ...
    static EQUAL(
      left: PackedByteArray | byte[] | ArrayBuffer,
      right: PackedByteArray | byte[] | ArrayBuffer,
    ): boolean;
    static NOT_EQUAL(
      left: PackedByteArray | byte[] | ArrayBuffer,
      right: PackedByteArray | byte[] | ArrayBuffer,
  ...
  class PackedInt32Array {
    ...
    erase(value: int64): boolean;
    static EQUAL(
      left: PackedInt32Array | int32[],
      right: PackedInt32Array | int32[],
    ): boolean;
    static NOT_EQUAL(
      left: PackedInt32Array | int32[],
      right: PackedInt32Array | int32[],
  ...
  class PackedInt64Array {
    ...
    erase(value: int64): boolean;
    static EQUAL(
      left: PackedInt64Array | int64[],
      right: PackedInt64Array | int64[],
    ): boolean;
    static NOT_EQUAL(
      left: PackedInt64Array | int64[],
      right: PackedInt64Array | int64[],
  ...
  class PackedFloat32Array {
    ...
    static EQUAL(
      left: PackedFloat32Array | float32[],
      right: PackedFloat32Array | float32[],
    ): boolean;
    static NOT_EQUAL(
      left: PackedFloat32Array | float32[],
      right: PackedFloat32Array | float32[],
  ...
  class PackedFloat64Array {
    ...
    erase(value: float64): boolean;
    static EQUAL(
      left: PackedFloat64Array | float64[],
      right: PackedFloat64Array | float64[],
    ): boolean;
    static NOT_EQUAL(
      left: PackedFloat64Array | float64[],
      right: PackedFloat64Array | float64[],
  ...
  class PackedVector4Array {
    ...
    static NOT_EQUAL(
      left: PackedVector4Array,
      right: PackedVector4Array,
    ): boolean;
  }
  ...
  class PackedColorArray {
    ...
    static EQUAL(
      left: PackedColorArray | Color[],
      right: PackedColorArray | Color[],
    ): boolean;
    static NOT_EQUAL(
      left: PackedColorArray | Color[],
      right: PackedColorArray | Color[],
  ...
  class String {
     ...
     *  - For macOS and Linux/BSD, see `libiconv` library documentation and `iconv --list` for a list of supported encodings.
     */
    static to_multibyte_char_buffer(
      target: string,
      encoding?: string /* = '' */,
    ): PackedByteArray;
  ...
  function cubic_interpolate_angle(
    from: float64,
    to: float64,
    pre: float64,
    post: float64,
   ...
   *  It can perform smoother interpolation than [method cubic_interpolate] by the time values.
   */
  function cubic_interpolate_in_time(
    from: float64,
    to: float64,
    pre: float64,
    post: float64,
