declare module "godot.lib.api" {
  ...
  function object_proxy<T extends object>(
    obj: T,
    remap_properties?: boolean,
  ): T;
  function key_only_proxy<T extends object | ((...args: any[]) => any)>(
    target: T,
  ): any;
...
declare module "godot.annotations" {
  ...
  type VariantConstructor = abstract new (
    ...args: any[]
  ) => NonNullable<Godot.GAny> | Number | String | Boolean;
  ...
  /** @deprecated Use createClassBinder() instead. */
  export function export_range_i(
    min: number,
    max: number,
    step?: number,
    ...extra_hints: string[]
  ...
  /** @deprecated Use createClassBinder() instead. */
  export function export_exp_easing(
   ...
   */
  /** @deprecated Use createClassBinder() instead. */
  export function export_dictionary(
  ...
  /** @deprecated Use createClassBinder() instead. */
  export function export_object(
    clazz: GObjectConstructor,
  ): (target: any, name: string) => void;
  /** @deprecated Use createClassBinder() instead. */
  ...
  export function export_enum(
    enum_type: Record<string, string | number>,
  ): (target: any, name: string) => void;
  /** @deprecated Use createClassBinder() instead. */
  ...
  export type ClassMemberDecorator<
    RestrictedContext extends
  ...
  export type ClassMemberDecoratorTarget<
  ...
  export type ClassDecorator<
    This extends abstract new (...args: any) => any = abstract new (
      ...args: any
    ) => any,
  ...
  export type Decorator<
    RestrictedContext extends DecoratorContext = DecoratorContext,
  > = RestrictedContext extends ClassDecoratorContext
    ? <Context extends RestrictedContext>(
        target: ClassDecoratorClass<Context>,
        context: Context,
      ) => void
  ...
  export type ClassValueMemberDecoratorContext<
    This = unknown,
    Value = unknown,
  > =
...
declare module "godot.typeloader" {
  ...
  export function on_type_loaded(
    type_name: string | string[],
    callback: TypeLoadedCallback,
  ): void;
}
