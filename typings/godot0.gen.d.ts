...
declare module "godot" {
  ...
  class Engine extends Object {
     ...
     */
    static capture_script_backtraces(
      include_variables?: boolean /* = false */,
    ): GArray<ScriptBacktrace>;
  ...
  class ProjectSettings extends Object {
    ...
    static get_setting_with_override_and_custom_features(
      name: StringName,
      features: PackedStringArray | string[],
    ): any;
     ...
     */
    static load_resource_pack(
      pack: string,
      replace_files?: boolean /* = true */,
      offset?: int64 /* = 0 */,
    ): boolean;
  ...
  class OS extends Object {
     ...
     *  **Note:** This method is implemented on Android, iOS, Linux, macOS and Windows.
     */
    static get_system_font_path_for_text(
      font_name: string,
      text: string,
      locale?: string /* = '' */,
      script?: string /* = '' */,
    ...
    static execute(
      path: string,
      arguments_: PackedStringArray | string[],
      output?: GArray /* = [] */,
      read_stderr?: boolean /* = false */,
      open_console?: boolean /* = false */,
    ): int64;
     ...
     */
    static open_with_program(
      program_path: string,
      paths: PackedStringArray | string[],
    ): Error;
     ...
     */
    static shell_show_in_file_manager(
      file_or_dir_path: string,
      open_folder?: boolean /* = true */,
    ): Error;
     ...
     */
    static get_system_dir(
      dir: OS.SystemDir,
      shared_storage?: boolean /* = true */,
    ): string;
  ...
  class Time extends Object {
     ...
     */
    static get_datetime_string_from_unix_time(
      unix_time_val: int64,
      use_space?: boolean /* = false */,
    ): string;
     ...
     */
    static get_datetime_dict_from_datetime_string(
      datetime: string,
      weekday: boolean,
    ): GDictionary;
     ...
     *  If [param use_space] is `true`, the date and time bits are separated by an empty space character instead of the letter T.
     */
    static get_datetime_string_from_datetime_dict(
      datetime: GDictionary,
      use_space: boolean,
    ): string;
    ...
    static get_datetime_dict_from_system(
      utc?: boolean /* = false */,
    ): GDictionary;
     ...
     *  If [param use_space] is `true`, the date and time bits are separated by an empty space character instead of the letter T.
     */
    static get_datetime_string_from_system(
      utc?: boolean /* = false */,
      use_space?: boolean /* = false */,
    ): string;
  ...
  class TextServerManager extends Object {
    ...
    static readonly interface_added: Signal<
      (interface_name: StringName) => void
    >;
  ...
  class NavigationMeshGenerator extends Object {
    ...
    static bake_from_source_geometry_data(
      navigation_mesh: NavigationMesh,
      source_geometry_data: NavigationMeshSourceGeometryData3D,
      callback?: Callable /* = new Callable() */,
    ): void;
  ...
  class IP extends Object {
    ...
    static resolve_hostname_addresses(
      host: string,
      ip_type?: IP.Type /* = 3 */,
    ): PackedStringArray;
    ...
    static resolve_hostname_queue_item(
      host: string,
      ip_type?: IP.Type /* = 3 */,
    ): int64;
  ...
  class Geometry2D extends Object {
    ...
    static segment_intersects_circle(
    ...
    static segment_intersects_segment(
      from_a: Vector2,
      to_a: Vector2,
      from_b: Vector2,
      to_b: Vector2,
    ...
    static get_closest_points_between_segments(
      p1: Vector2,
      q1: Vector2,
      p2: Vector2,
      q2: Vector2,
    ...
    static get_closest_point_to_segment(
      point: Vector2,
      s1: Vector2,
      s2: Vector2,
    ): Vector2;
    ...
    static get_closest_point_to_segment_uncapped(
      point: Vector2,
      s1: Vector2,
      s2: Vector2,
    ): Vector2;
    ...
    static point_is_inside_triangle(
      point: Vector2,
      a: Vector2,
      b: Vector2,
      c: Vector2,
    ...
    static decompose_polygon_in_convex(
      polygon: PackedVector2Array | Vector2[],
    ): GArray<PackedVector2Array>;
     ...
     */
    static merge_polygons(
      polygon_a: PackedVector2Array | Vector2[],
      polygon_b: PackedVector2Array | Vector2[],
    ): GArray<PackedVector2Array>;
    ...
    static clip_polyline_with_polygon(
    ...
    static intersect_polyline_with_polygon(
      polyline: PackedVector2Array | Vector2[],
      polygon: PackedVector2Array | Vector2[],
    ): GArray<PackedVector2Array>;
     ...
     *
     */
    static offset_polygon(
      polygon: PackedVector2Array | Vector2[],
      delta: float64,
      join_type?: Geometry2D.PolyJoinType /* = 0 */,
    ): GArray<PackedVector2Array>;
     ...
     *  The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling [method is_polygon_clockwise].
     */
    static offset_polyline(
      polyline: PackedVector2Array | Vector2[],
      delta: float64,
      join_type?: Geometry2D.PolyJoinType /* = 0 */,
      end_type?: Geometry2D.PolyEndType /* = 3 */,
    ): GArray<PackedVector2Array>;
  ...
  class Geometry3D extends Object {
    ...
    static compute_convex_mesh_points(
      planes: GArray<Plane>,
    ): PackedVector3Array;
     ...
     */
    static get_triangle_barycentric_coords(
      point: Vector3,
      a: Vector3,
      b: Vector3,
      c: Vector3,
    ...
    static ray_intersects_triangle(
      from: Vector3,
      dir: Vector3,
      a: Vector3,
      b: Vector3,
    ...
    static segment_intersects_triangle(
      from: Vector3,
      to: Vector3,
      a: Vector3,
      b: Vector3,
    ...
    static segment_intersects_sphere(
      from: Vector3,
      to: Vector3,
    ...
    static segment_intersects_cylinder(
      from: Vector3,
      to: Vector3,
      height: float64,
      radius: float64,
    ...
    static segment_intersects_convex(
      from: Vector3,
      to: Vector3,
      planes: GArray<Plane>,
    ): PackedVector3Array;
    ...
    static clip_polygon(
      points: PackedVector3Array | Vector3[],
      plane: Plane,
    ): PackedVector3Array;
    ...
    static tetrahedralize_delaunay(
      points: PackedVector3Array | Vector3[],
    ): PackedInt32Array;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class ResourceLoader extends Object {
     ...
     */
    static load_threaded_request(
      path: string,
      type_hint?: string /* = '' */,
      use_sub_threads?: boolean /* = false */,
     ...
     */
    static load_threaded_get_status(
      path: string,
      progress?: GArray /* = [] */,
     ...
     */
    static load_threaded_get<Path extends keyof ResourceTypes>(
      path: Path,
    ): ResourceTypes[Path];
     ...
     */
    static load<Path extends keyof ResourceTypes>(
      path: Path,
      type_hint?: string /* = "" */,
      cache_mode?: ResourceLoader.CacheMode /* = 1 */,
    ): ResourceTypes[Path];
     ...
     */
    static add_resource_format_loader(
      format_loader: ResourceFormatLoader,
      at_front?: boolean /* = false */,
    ): void;

    /** Unregisters the given [ResourceFormatLoader]. */
    static remove_resource_format_loader(
      format_loader: ResourceFormatLoader,
    ): void;
  ...
  class ResourceSaver extends Object {
     ...
     */
    static add_resource_format_saver(
      format_saver: ResourceFormatSaver,
      at_front?: boolean /* = false */,
    ): void;

    /** Unregisters the given [ResourceFormatSaver]. */
    static remove_resource_format_saver(
      format_saver: ResourceFormatSaver,
    ): void;
    ...
    static get_resource_id_for_path(
      path: string,
  ...
  class ClassDB extends Object {
    ...
    static class_get_method_argument_count(
      class_: StringName,
      method: StringName,
      no_inheritance?: boolean /* = false */,
    ): int64;
     ...
     */
    static class_get_method_list(
      class_: StringName,
      no_inheritance?: boolean /* = false */,
    ): GArray<GDictionary>;

    /** Calls a static method on a class. */
    static class_call_static(
      class_: StringName,
      method: StringName,
      ...varargs: any[]
    ): any;
    ...
    static class_get_integer_constant_enum(
      class_: StringName,
      name: StringName,
      no_inheritance?: boolean /* = false */,
    ): StringName;
  ...
  class Marshalls extends Object {
     ...
     */
    static variant_to_base64(
      variant: any,
      full_objects?: boolean /* = false */,
    ): string;
  ...
  class TranslationServer extends Object {
    ...
    static standardize_locale(
      locale: string,
      add_defaults?: boolean /* = false */,
    ): string;
  ...
  class Input extends Object {
     ...
     */
    static is_action_just_released(
      action: InputActionName,
      exact_match?: boolean /* = false */,
    ): boolean;
     ...
     *  **Note:** Due to keyboard ghosting, [method is_action_just_pressed] may return `false` even if one of the action's keys is pressed. See [url=https://docs.godotengine.org/en/4.5/tutorials/inputs/input_examples.html#keyboard-events]Input examples[/url] in the documentation for more information.
     */
    static is_action_just_pressed_by_event(
      action: StringName,
      event: InputEvent,
      exact_match?: boolean /* = false */,
    ): boolean;
     ...
     *  If [param exact_match] is `false`, it ignores additional input modifiers for [InputEventKey] and [InputEventMouseButton] events, and the direction for [InputEventJoypadMotion] events.
     */
    static is_action_just_released_by_event(
      action: StringName,
      event: InputEvent,
      exact_match?: boolean /* = false */,
    ): boolean;
     ...
     *  If [param exact_match] is `false`, it ignores additional input modifiers for [InputEventKey] and [InputEventMouseButton] events, and the direction for [InputEventJoypadMotion] events.
     */
    static get_action_raw_strength(
      action: InputActionName,
      exact_match?: boolean /* = false */,
    ): float64;
     ...
     */
    static get_axis(
      negative_action: InputActionName,
      positive_action: InputActionName,
    ): float64;
     ...
     */
    static get_vector(
      negative_x: InputActionName,
      positive_x: InputActionName,
      negative_y: InputActionName,
      positive_y: InputActionName,
      deadzone?: float64 /* = -1 */,
    ): Vector2;

    /** Adds a new mapping entry (in SDL2 format) to the mapping database. Optionally update already connected devices. */
    static add_joy_mapping(
      mapping: string,
      update_existing?: boolean /* = false */,
    ): void;
     ...
     */
    static set_custom_mouse_cursor(
      image: Resource,
      shape?: Input.CursorShape /* = 0 */,
    ...
    static readonly joy_connection_changed: Signal<
      (device: int64, connected: boolean) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class InputMap extends Object {
    ...
    static add_action(
      action: StringName,
      deadzone?: float64 /* = 0.20000000298023224 */,
    ): void;
  ...
  class EngineDebugger extends Object {
    ...
    static debug(
      can_continue?: boolean /* = true */,
      is_error_breakpoint?: boolean /* = false */,
    ): void;
  ...
  class GDExtensionManager extends Object {
     ...
     *  **Note:** This signal is only emitted in editor builds.
     */
    static readonly extension_unloading: Signal<
      (extension: GDExtension) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class WorkerThreadPool extends Object {
     ...
     *  **Warning:** Every task must be waited for completion using [method wait_for_task_completion] or [method wait_for_group_task_completion] at some point so that any allocated resources inside the task can be cleaned up.
     */
    static add_group_task(
      action: Callable,
      elements: int64,
      tasks_needed?: int64 /* = -1 */,
      high_priority?: boolean /* = false */,
      description?: string /* = '' */,
    ): int64;
  ...
  class EditorInterface extends Object {
    ...
    static popup_dialog(
      dialog: Window,
      rect?: Rect2i /* = new Rect2i(0, 0, 0, 0) */,
    ): void;
     ...
     *  See also [method Window.set_unparent_when_invisible].
     */
    static popup_dialog_centered(
      dialog: Window,
      minsize?: Vector2i /* = Vector2i.ZERO */,
    ): void;
     ...
     *  See also [method Window.set_unparent_when_invisible].
     */
    static popup_dialog_centered_clamped(
      dialog: Window,
      minsize?: Vector2i /* = Vector2i.ZERO */,
      fallback_ratio?: float64 /* = 0.75 */,
    ): void;
     ...
     *
     */
    static popup_node_selector(
      callback: Callable,
      valid_types?: GArray<StringName> /* = [] */,
      current_value?: Node /* = undefined */,
    ): void;
     ...
     *
     */
    static popup_property_selector(
      object: Object,
      callback: Callable,
      type_filter?: PackedInt32Array | int32[] /* = [] */,
    ...
    static popup_quick_open(
      callback: Callable,
      base_types?: GArray<StringName> /* = [] */,
    ): void;
    ...
    static popup_create_dialog(
      ...
      current_type?: string /* = '' */,
      dialog_title?: string /* = '' */,
      type_blocklist?: GArray<StringName> /* = [] */,
    ): void;
    ...
    static inspect_object(
      object: Object,
      for_property?: string /* = '' */,
      inspector_only?: boolean /* = false */,
    ): void;
    ...
    static save_scene_as(
      path: string,
      with_preview?: boolean /* = true */,
    ): void;
  ...
  class JavaScriptBridge extends Object {
    ...
    static eval(
      code: string,
      use_global_execution_context?: boolean /* = false */,
    ): any;
    ...
    static js_buffer_to_packed_byte_array(
      javascript_buffer: JavaScriptObject,
    ): PackedByteArray;
     ...
     */
    static download_buffer(
      buffer: PackedByteArray | byte[] | ArrayBuffer,
      name: string,
  ...
  class AudioServer extends Object {
    ...
    static get_bus_effect(
      bus_idx: int64,
      effect_idx: int64,
    ): null | AudioEffect;

    /** Returns the [AudioEffectInstance] assigned to the given bus and effect indices (and optionally channel). */
    static get_bus_effect_instance(
      bus_idx: int64,
      effect_idx: int64,
      channel?: int64 /* = 0 */,
    ): null | AudioEffectInstance;

    /** Swaps the position of two effects in bus [param bus_idx]. */
    static swap_bus_effects(
      bus_idx: int64,
      effect_idx: int64,
      by_effect_idx: int64,
    ): void;
    ...
    static get_bus_peak_volume_right_db(
      bus_idx: int64,
      channel: int64,
    ): float64;
    ...
    static readonly bus_renamed: Signal<
      (bus_index: int64, old_name: StringName, new_name: StringName) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class DisplayServer extends Object {
     ...
     */
    static help_set_search_callbacks(
    ...
    static global_menu_set_popup_callbacks(
      menu_root: string,
     ...
     *  [/codeblock]
     */
    static global_menu_add_submenu_item(
      menu_root: string,
      label: string,
      submenu: string,
      index?: int64 /* = -1 */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_item(
      menu_root: string,
      label: string,
      callback?: Callable /* = new Callable() */,
      key_callback?: Callable /* = new Callable() */,
      tag?: any /* = <any> {} */,
      accelerator?: Key /* = 0 */,
      index?: int64 /* = -1 */,
    ): int64;
     ...
     *  [/codeblock]
     */
    static global_menu_add_check_item(
      menu_root: string,
      label: string,
      callback?: Callable /* = new Callable() */,
      key_callback?: Callable /* = new Callable() */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_icon_item(
      menu_root: string,
      icon: Texture2D,
      label: string,
      callback?: Callable /* = new Callable() */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_icon_check_item(
      menu_root: string,
      icon: Texture2D,
      label: string,
      callback?: Callable /* = new Callable() */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_radio_check_item(
      menu_root: string,
      label: string,
      callback?: Callable /* = new Callable() */,
      key_callback?: Callable /* = new Callable() */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_icon_radio_check_item(
      menu_root: string,
      icon: Texture2D,
      label: string,
      callback?: Callable /* = new Callable() */,
     ...
     *  [/codeblock]
     */
    static global_menu_add_multistate_item(
      menu_root: string,
      label: string,
      max_states: int64,
      default_state: int64,
     ...
     *  [/codeblock]
     */
    static global_menu_add_separator(
      menu_root: string,
      index?: int64 /* = -1 */,
    ): int64;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_index_from_text(
      menu_root: string,
      text: string,
    ): int64;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_index_from_tag(
      menu_root: string,
      tag: any,
    ): int64;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_is_item_checkable(
      menu_root: string,
      idx: int64,
    ): boolean;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_is_item_radio_checkable(
      menu_root: string,
      idx: int64,
    ): boolean;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_callback(
      menu_root: string,
      idx: int64,
    ): Callable;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_key_callback(
      menu_root: string,
      idx: int64,
    ): Callable;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_max_states(
      menu_root: string,
      idx: int64,
    ): int64;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_icon(
      menu_root: string,
      idx: int64,
    ): null | Texture2D;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_get_item_indentation_level(
      menu_root: string,
      idx: int64,
    ): int64;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_checked(
      menu_root: string,
      idx: int64,
      checked: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_checkable(
      menu_root: string,
      idx: int64,
      checkable: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_radio_checkable(
      menu_root: string,
      idx: int64,
      checkable: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_callback(
      menu_root: string,
      idx: int64,
      callback: Callable,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_hover_callbacks(
      menu_root: string,
      idx: int64,
      callback: Callable,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_key_callback(
      menu_root: string,
      idx: int64,
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_tag(
      menu_root: string,
      idx: int64,
      tag: any,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_text(
      menu_root: string,
      idx: int64,
      text: string,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_submenu(
      menu_root: string,
      idx: int64,
      submenu: string,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_accelerator(
      menu_root: string,
      idx: int64,
      keycode: Key,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_disabled(
      menu_root: string,
      idx: int64,
      disabled: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_hidden(
      menu_root: string,
      idx: int64,
      hidden: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_tooltip(
      menu_root: string,
      idx: int64,
      tooltip: string,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_state(
      menu_root: string,
      idx: int64,
      state: int64,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_max_states(
      menu_root: string,
      idx: int64,
      max_states: int64,
    ): void;
     ...
     */
    static global_menu_set_item_icon(
      menu_root: string,
      idx: int64,
      icon: Texture2D,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static global_menu_set_item_indentation_level(
      menu_root: string,
      idx: int64,
      level: int64,
    ): void;
     ...
     *  **Note:** This method is implemented on Android, iOS, Web, Linux (X11/Wayland), macOS, and Windows.
     */
    static tts_set_utterance_callback(
      event: DisplayServer.TTSUtteranceEvent,
      callable: Callable,
    ): void;
    static _tts_post_utterance_event(
      event: DisplayServer.TTSUtteranceEvent,
      id: int64,
      char_pos: int64,
    ): void;
     ...
     */
    static window_get_native_handle(
      handle_type: DisplayServer.HandleType,
      window_id?: int64 /* = 0 */,
    ): int64;
     ...
     */
    static window_set_mouse_passthrough(
      region: PackedVector2Array | Vector2[],
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     *  **Note:** This method is implemented on Linux/X11, macOS, and Windows.
     */
    static window_set_current_screen(
      screen: int64,
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     */
    static window_set_rect_changed_callback(
      callback: Callable,
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     *  **Warning:** Advanced users only! Adding such a callback to a [Window] node will override its default implementation, which can introduce bugs.
     */
    static window_set_input_event_callback(
      callback: Callable,
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     *  **Warning:** Advanced users only! Adding such a callback to a [Window] node will override its default implementation, which can introduce bugs.
     */
    static window_set_input_text_callback(
      callback: Callable,
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     */
    static window_set_drop_files_callback(
      callback: Callable,
      window_id?: int64 /* = 0 */,
    ): void;
    ...
    static window_get_size_with_decorations(
      window_id?: int64 /* = 0 */,
    ): Vector2i;

    /** Returns the mode of the given window. */
    static window_get_mode(
      window_id?: int64 /* = 0 */,
     ...
     *  **Note:** This flag is implemented only on macOS.
     */
    static window_set_window_buttons_offset(
      offset: Vector2i,
      window_id?: int64 /* = 0 */,
    ): void;
    ...
    static window_set_ime_position(
      position: Vector2i,
      window_id?: int64 /* = 0 */,
    ): void;
     ...
     */
    static window_set_vsync_mode(
      vsync_mode: DisplayServer.VSyncMode,
      window_id?: int64 /* = 0 */,
    ): void;

    /** Returns the V-Sync mode of the given window. */
    static window_get_vsync_mode(
      window_id?: int64 /* = 0 */,
     ...
     */
    static accessibility_create_element(
      window_id: int64,
      role: DisplayServer.AccessibilityRole,
    ): RID;
    ...
    static accessibility_create_sub_element(
      parent_rid: RID,
      role: DisplayServer.AccessibilityRole,
      insert_pos?: int64 /* = -1 */,
    ): RID;
    ...
    static accessibility_create_sub_text_edit_elements(
      parent_rid: RID,
      shaped_text: RID,
      min_height: float64,
      insert_pos?: int64 /* = -1 */,
     ...
     */
    static accessibility_set_window_rect(
      window_id: int64,
      rect_out: Rect2,
      rect_in: Rect2,
    ): void;
     ...
     *  **Note:** Advanced users only! [Window] objects call this method automatically.
     */
    static accessibility_set_window_focused(
      window_id: int64,
      focused: boolean,
    ): void;
    ...
    static accessibility_update_set_role(
      id: RID,
      role: DisplayServer.AccessibilityRole,
    ): void;
    ...
    static accessibility_update_set_description(
      id: RID,
      description: string,
    ): void;
    ...
    static accessibility_update_set_transform(
      id: RID,
    ...
    static accessibility_update_add_related_controls(
      id: RID,
      related_id: RID,
    ): void;

    /** Adds an element that details this element. */
    static accessibility_update_add_related_details(
      id: RID,
      related_id: RID,
    ): void;

    /** Adds an element that describes this element. */
    static accessibility_update_add_related_described_by(
      id: RID,
      related_id: RID,
    ): void;

    /** Adds an element that this element flow into. */
    static accessibility_update_add_related_flow_to(
      id: RID,
      related_id: RID,
    ): void;

    /** Adds an element that labels this element. */
    static accessibility_update_add_related_labeled_by(
      id: RID,
      related_id: RID,
    ): void;
     ...
     */
    static accessibility_update_add_related_radio_group(
      id: RID,
      related_id: RID,
    ): void;

    /** Adds an element that is an active descendant of this element. */
    static accessibility_update_set_active_descendant(
      id: RID,
      other_id: RID,
    ): void;
    ...
    static accessibility_update_set_previous_on_line(
      id: RID,
      other_id: RID,
    ): void;
    ...
    static accessibility_update_set_in_page_link_target(
      id: RID,
      other_id: RID,
    ): void;
    ...
    static accessibility_update_set_live(
      id: RID,
      live: DisplayServer.AccessibilityLiveMode,
    ): void;
    ...
    static accessibility_update_add_action(
      id: RID,
      action: DisplayServer.AccessibilityAction,
      callable: Callable,
    ): void;
    ...
    static accessibility_update_add_custom_action(
      id: RID,
      action_id: int64,
    ...
    static accessibility_update_set_table_row_count(
      id: RID,
      count: int64,
    ): void;

    /** Sets number of columns in the table. */
    static accessibility_update_set_table_column_count(
      id: RID,
      count: int64,
    ): void;

    /** Sets position of the row in the table. */
    static accessibility_update_set_table_row_index(
      id: RID,
      index: int64,
    ): void;

    /** Sets position of the column. */
    static accessibility_update_set_table_column_index(
      id: RID,
      index: int64,
    ): void;

    /** Sets cell position in the table. */
    static accessibility_update_set_table_cell_position(
      id: RID,
      row_index: int64,
      column_index: int64,
    ): void;
    ...
    static accessibility_update_set_table_cell_span(
      id: RID,
      row_span: int64,
      column_span: int64,
    ): void;
    ...
    static accessibility_update_set_list_item_index(
      id: RID,
      index: int64,
    ): void;

    /** Sets the hierarchical level of the element in the list. */
    static accessibility_update_set_list_item_level(
      id: RID,
      level: int64,
    ): void;

    /** Sets list/tree item selected status. */
    static accessibility_update_set_list_item_selected(
      id: RID,
      selected: boolean,
    ): void;

    /** Sets list/tree item expanded status. */
    static accessibility_update_set_list_item_expanded(
      id: RID,
      expanded: boolean,
    ): void;

    /** Sets popup type for popup buttons. */
    static accessibility_update_set_popup_type(
      id: RID,
      popup: DisplayServer.AccessibilityPopupType,
    ): void;
    ...
    static accessibility_update_set_num_range(
      id: RID,
      min: float64,
      max: float64,
    ): void;
    ...
    static accessibility_update_set_scroll_x_range(
      id: RID,
      min: float64,
      max: float64,
    ): void;
    ...
    static accessibility_update_set_scroll_y_range(
      id: RID,
      min: float64,
      max: float64,
    ): void;
    ...
    static accessibility_update_set_text_decorations(
      id: RID,
      underline: boolean,
    ...
    static accessibility_update_set_text_align(
      id: RID,
    ...
    static accessibility_update_set_text_selection(
      id: RID,
      text_start_id: RID,
      start_char: int64,
      text_end_id: RID,
    ...
    /** Sets element flag. */
    static accessibility_update_set_flag(
      id: RID,
      flag: DisplayServer.AccessibilityFlags,
      value: boolean,
    ): void;
    ...
    static accessibility_update_set_placeholder(
      id: RID,
      placeholder: string,
    ): void;
    ...
    static accessibility_update_set_text_orientation(
      id: RID,
      vertical: boolean,
    ): void;

    /** Sets the orientation of the list elements. */
    static accessibility_update_set_list_orientation(
      id: RID,
      vertical: boolean,
    ): void;
    ...
    static accessibility_update_set_role_description(
      id: RID,
      description: string,
    ): void;

    /** Sets human-readable description of the current checked state. */
    static accessibility_update_set_state_description(
      id: RID,
      description: string,
    ): void;
    ...
    static accessibility_update_set_background_color(
      id: RID,
      color: Color,
    ): void;

    /** Sets element foreground color. */
    static accessibility_update_set_foreground_color(
      id: RID,
      color: Color,
    ): void;
     ...
     */
    static virtual_keyboard_show(
      existing_text: string,
      position?: Rect2 /* = new Rect2(0, 0, 0, 0) */,
      type?: DisplayServer.VirtualKeyboardType /* = 0 */,
      max_length?: int64 /* = -1 */,
      cursor_start?: int64 /* = -1 */,
      cursor_end?: int64 /* = -1 */,
    ): void;
     ...
     */
    static set_hardware_keyboard_connection_change_callback(
      callable: Callable,
    ): void;
     ...
     */
    static cursor_set_custom_image(
      cursor: Resource,
      shape?: DisplayServer.CursorShape /* = 0 */,
      hotspot?: Vector2 /* = Vector2.ZERO */,
    ): void;
    ...
    static dialog_show(
      title: string,
      description: string,
      buttons: PackedStringArray | string[],
      callback: Callable,
    ): Error;
     ...
     */
    static file_dialog_show(
      title: string,
      current_directory: string,
      filename: string,
      show_hidden: boolean,
      mode: DisplayServer.FileDialogMode,
      filters: PackedStringArray | string[],
      callback: Callable,
      parent_window_id?: int64 /* = 0 */,
    ): Error;
     ...
     *  **Note:** On macOS, sandboxed apps will save security-scoped bookmarks to retain access to the opened folders across multiple sessions. Use [method OS.get_granted_permissions] to get a list of saved bookmarks.
     */
    static file_dialog_with_options_show(
      title: string,
      current_directory: string,
      root: string,
      filename: string,
     ...
     */
    static create_status_indicator(
      icon: Texture2D,
      tooltip: string,
      callback: Callable,
    ): int64;
  ...
  class NativeMenu extends Object {
     ...
     *  **Note:** On Windows, [param accelerator] and [param key_callback] are ignored.
     */
    static add_icon_radio_check_item(
      rid: RID,
      icon: Texture2D,
      label: string,
      callback?: Callable /* = new Callable() */,
     ...
     *  **Note:** This method is implemented on macOS and Windows.
     */
    static set_item_radio_checkable(
      rid: RID,
      idx: int64,
      checkable: boolean,
    ): void;
     ...
     *  **Note:** This method is implemented only on macOS.
     */
    static set_item_hover_callbacks(
      rid: RID,
      idx: int64,
      callback: Callable,
    ): void;
  ...
  class RenderingServer extends Object {
     ...
     */
    static texture_2d_layered_create(
      layers: GArray<Image>,
      layered_type: RenderingServer.TextureLayeredType,
    ): RID;

    /**
     *  **Note:** The equivalent resource is [Texture3D].
     */
    static texture_3d_create(
      format: Image.Format,
      width: int64,
      height: int64,
      depth: int64,
     ...
     */
    static texture_create_from_native_handle(
      type: RenderingServer.TextureType,
      format: Image.Format,
      native_handle: int64,
      width: int64,
      height: int64,
      depth: int64,
      layers?: int64 /* = 1 */,
      layered_type?: RenderingServer.TextureLayeredType /* = 0 */,
    ): RID;
     ...
     */
    static texture_2d_layered_placeholder_create(
      layered_type: RenderingServer.TextureLayeredType,
    ): RID;
    ...
    static texture_set_size_override(
      texture: RID,
      width: int64,
      height: int64,
    ): void;
    ...
    static texture_set_force_redraw_if_visible(
      texture: RID,
      enable: boolean,
    ): void;
    ...
    static texture_rd_create(
      rd_texture: RID,
      layer_type?: RenderingServer.TextureLayeredType /* = 0 */,
    ): RID;

    /** Returns a texture [RID] that can be used with [RenderingDevice]. */
    static texture_get_rd_texture(
      texture: RID,
      srgb?: boolean /* = false */,
    ): RID;
     ...
     */
    static texture_get_native_handle(
      texture: RID,
      srgb?: boolean /* = false */,
    ): int64;
     ...
     */
    static shader_set_default_texture_parameter(
      shader: RID,
      name: StringName,
      texture: RID,
      index?: int64 /* = 0 */,
     ...
     *  **Note:** If the sampler array is used use [param index] to access the specified texture.
     */
    static shader_get_default_texture_parameter(
      shader: RID,
      name: StringName,
      index?: int64 /* = 0 */,
    ): RID;
    ...
    static mesh_create_from_surfaces(
      surfaces: GArray<GDictionary>,
      blend_shape_count?: int64 /* = 0 */,
    ): RID;
    ...
    static mesh_surface_get_format_offset(
    ...
    static mesh_surface_get_format_vertex_stride(
      format: RenderingServer.ArrayFormat,
      vertex_count: int64,
    ): int64;
    ...
    static mesh_set_blend_shape_mode(
      mesh: RID,
    ...
    static mesh_surface_set_material(
      mesh: RID,
      surface: int64,
      material: RID,
    ): void;
    ...
    static mesh_surface_get_blend_shape_arrays(
      mesh: RID,
      surface: int64,
    ): GArray<GArray>;
    ...
    static mesh_surface_update_vertex_region(
      mesh: RID,
      surface: int64,
      offset: int64,
      data: PackedByteArray | byte[] | ArrayBuffer,
    ): void;
    static mesh_surface_update_attribute_region(
      mesh: RID,
      surface: int64,
      offset: int64,
      data: PackedByteArray | byte[] | ArrayBuffer,
    ): void;
    static mesh_surface_update_skin_region(
      mesh: RID,
      surface: int64,
      offset: int64,
      data: PackedByteArray | byte[] | ArrayBuffer,
    ...
    static mesh_surface_update_index_region(
      mesh: RID,
      surface: int64,
      offset: int64,
      data: PackedByteArray | byte[] | ArrayBuffer,
    ...
    static multimesh_allocate_data(
      multimesh: RID,
      instances: int64,
      transform_format: RenderingServer.MultimeshTransformFormat,
      color_format?: boolean /* = false */,
      custom_data_format?: boolean /* = false */,
      use_indirect?: boolean /* = false */,
    ): void;
    ...
    static multimesh_instance_set_transform(
      multimesh: RID,
      index: int64,
    ...
    static multimesh_instance_set_color(
      multimesh: RID,
      index: int64,
      color: Color,
    ): void;
    ...
    static multimesh_instance_set_custom_data(
      multimesh: RID,
      index: int64,
      custom_data: Color,
    ): void;
    ...
    static multimesh_instance_get_transform(
      multimesh: RID,
      index: int64,
    ): Transform3D;

    /** Returns the [Transform2D] of the specified instance. For use when the multimesh is set to use 2D transforms. */
    static multimesh_instance_get_transform_2d(
      multimesh: RID,
      index: int64,
    ): Transform2D;
    ...
    static multimesh_instance_get_custom_data(
      multimesh: RID,
      index: int64,
    ): Color;

    /** Sets the number of instances visible at a given time. If -1, all instances that have been allocated are drawn. Equivalent to [member MultiMesh.visible_instance_count]. */
    static multimesh_set_visible_instances(
      multimesh: RID,
      visible: int64,
    ): void;
     ...
     */
    static multimesh_set_buffer(
      multimesh: RID,
      buffer: PackedFloat32Array | float32[],
    ): void;
     ...
     */
    static multimesh_set_buffer_interpolated(
      multimesh: RID,
      buffer: PackedFloat32Array | float32[],
      buffer_previous: PackedFloat32Array | float32[],
    ): void;

    /** Turns on and off physics interpolation for this MultiMesh resource. */
    static multimesh_set_physics_interpolated(
      multimesh: RID,
     ...
     */
    static multimesh_set_physics_interpolation_quality(
      multimesh: RID,
      quality: RenderingServer.MultimeshPhysicsInterpolationQuality,
    ): void;

    /** Prevents physics interpolation for the specified instance during the current physics tick.
     *  This is useful when moving an instance to a new location, to give an instantaneous change rather than interpolation from the previous location.
     */
    static multimesh_instance_reset_physics_interpolation(
      multimesh: RID,
      index: int64,
    ): void;
    ...
    static skeleton_allocate_data(
      skeleton: RID,
      bones: int64,
      is_2d_skeleton?: boolean /* = false */,
    ): void;
    ...
    static skeleton_bone_set_transform(
      skeleton: RID,
      bone: int64,
      transform: Transform3D,
    ): void;
    ...
    static skeleton_bone_set_transform_2d(
      skeleton: RID,
      bone: int64,
      transform: Transform2D,
    ): void;
    ...
    static skeleton_bone_get_transform_2d(
      skeleton: RID,
      bone: int64,
    ): Transform2D;
    static skeleton_set_base_transform_2d(
      skeleton: RID,
    ...
    static light_set_distance_fade(
      decal: RID,
      enabled: boolean,
      begin: float64,
      shadow: float64,
    ...
    static light_set_bake_mode(
      light: RID,
      bake_mode: RenderingServer.LightBakeMode,
    ): void;
    ...
    static light_omni_set_shadow_mode(
      light: RID,
    ...
    static light_directional_set_shadow_mode(
      light: RID,
    ...
    static light_directional_set_blend_splits(
      light: RID,
      enable: boolean,
    ): void;
    ...
    static light_directional_set_sky_mode(
      light: RID,
      mode: RenderingServer.LightDirectionalSkyMode,
    ): void;

    /** Sets the texture filter mode to use when rendering light projectors. This parameter is global and cannot be set on a per-light basis. */
    static light_projectors_set_filter(
    ...
    static positional_soft_shadow_filter_set_quality(
    ...
    static directional_soft_shadow_filter_set_quality(
      quality: RenderingServer.ShadowQuality,
    ): void;
    ...
    static directional_shadow_atlas_set_size(
      size: int64,
      is_16bits: boolean,
    ): void;
    ...
    static reflection_probe_set_update_mode(
      probe: RID,
    ...
    static reflection_probe_set_ambient_energy(
      probe: RID,
      energy: float64,
    ): void;
    ...
    static reflection_probe_set_max_distance(
      probe: RID,
      distance: float64,
    ): void;
    ...
    static reflection_probe_set_origin_offset(
      probe: RID,
      offset: Vector3,
    ): void;
    ...
    static reflection_probe_set_enable_box_projection(
      probe: RID,
      enable: boolean,
    ): void;
    ...
    static reflection_probe_set_enable_shadows(
      probe: RID,
      enable: boolean,
    ): void;
    ...
    static reflection_probe_set_mesh_lod_threshold(
      probe: RID,
      pixels: float64,
    ): void;
    ...
    static decal_set_distance_fade(
      decal: RID,
      enabled: boolean,
      begin: float64,
      length: float64,
    ...
    static voxel_gi_allocate_data(
      voxel_gi: RID,
      to_cell_xform: Transform3D,
      aabb: AABB,
      octree_size: Vector3i,
      octree_cells: PackedByteArray | byte[] | ArrayBuffer,
      data_cells: PackedByteArray | byte[] | ArrayBuffer,
      distance_field: PackedByteArray | byte[] | ArrayBuffer,
      level_counts: PackedInt32Array | int32[],
    ): void;
    ...
    static voxel_gi_set_baked_exposure_normalization(
      voxel_gi: RID,
    ...
    static lightmap_set_probe_capture_data(
      lightmap: RID,
      points: PackedVector3Array | Vector3[],
      point_sh: PackedColorArray | Color[],
      tetrahedra: PackedInt32Array | int32[],
      bsp_tree: PackedInt32Array | int32[],
    ): void;
    ...
    static lightmap_get_probe_capture_tetrahedra(
      lightmap: RID,
    ): PackedInt32Array;
    ...
    static lightmap_set_baked_exposure_normalization(
      lightmap: RID,
      baked_exposure: float64,
    ): void;
    ...
    static particles_set_explosiveness_ratio(
      particles: RID,
      ratio: float64,
    ): void;
    ...
    static particles_set_emitter_velocity(
      particles: RID,
      velocity: Vector3,
    ): void;
    ...
    static particles_set_use_local_coordinates(
      particles: RID,
      enable: boolean,
    ): void;
    ...
    static particles_set_fractional_delta(
      particles: RID,
      enable: boolean,
    ): void;
    static particles_set_collision_base_size(
      particles: RID,
      size: float64,
    ): void;
    static particles_set_transform_align(
      particles: RID,
    ...
    static particles_set_trails(
      particles: RID,
      enable: boolean,
      length_sec: float64,
    ): void;
    static particles_set_trail_bind_poses(
      particles: RID,
      bind_poses: GArray<Transform3D>,
    ): void;
    ...
    static particles_set_subemitter(
      particles: RID,
      subemitter_particles: RID,
    ): void;

    /** Manually emits particles from the [param particles] instance. */
    static particles_emit(
      particles: RID,
      transform: Transform3D,
      velocity: Vector3,
      color: Color,
    ...
    static particles_set_draw_order(
      particles: RID,
    ...
    static particles_set_draw_pass_mesh(
      particles: RID,
      pass: int64,
      mesh: RID,
    ): void;
    ...
    static particles_set_emission_transform(
      particles: RID,
      transform: Transform3D,
    ): void;
    ...
    static particles_collision_set_collision_type(
    ...
    static particles_collision_set_cull_mask(
      particles_collision: RID,
      mask: int64,
    ): void;
    ...
    static particles_collision_set_sphere_radius(
      particles_collision: RID,
      radius: float64,
    ): void;
    ...
    static particles_collision_set_box_extents(
      particles_collision: RID,
      extents: Vector3,
    ): void;
    ...
    static particles_collision_set_attractor_strength(
      particles_collision: RID,
      strength: float64,
    ): void;
    ...
    static particles_collision_set_attractor_directionality(
      particles_collision: RID,
      amount: float64,
    ): void;
    ...
    static particles_collision_set_attractor_attenuation(
      particles_collision: RID,
      curve: float64,
    ): void;
    ...
    static particles_collision_set_field_texture(
      particles_collision: RID,
      texture: RID,
    ): void;
    ...
    static particles_collision_height_field_update(
      particles_collision: RID,
    ): void;
    ...
    static particles_collision_set_height_field_resolution(
      particles_collision: RID,
    ...
    static particles_collision_set_height_field_mask(
      particles_collision: RID,
      mask: int64,
    ): void;
    ...
    static visibility_notifier_set_callbacks(
      notifier: RID,
    ...
    static occluder_set_mesh(
      occluder: RID,
      vertices: PackedVector3Array | Vector3[],
      indices: PackedInt32Array | int32[],
    ): void;
    ...
    static viewport_set_parent_viewport(
      viewport: RID,
      parent_viewport: RID,
    ): void;
     ...
     */
    static viewport_attach_to_screen(
      viewport: RID,
      rect?: Rect2 /* = new Rect2(0, 0, 0, 0) */,
      screen?: int64 /* = 0 */,
    ): void;
     ...
     */
    static viewport_set_texture_mipmap_bias(
      viewport: RID,
      mipmap_bias: float64,
    ): void;
     ...
     */
    static viewport_set_anisotropic_filtering_level(
      viewport: RID,
      anisotropic_filtering_level: RenderingServer.ViewportAnisotropicFiltering,
    ): void;

    /** Sets when the viewport should be updated. */
    static viewport_set_update_mode(
      viewport: RID,
      update_mode: RenderingServer.ViewportUpdateMode,
    ): void;
     ...
     */
    static viewport_get_update_mode(
      viewport: RID,
    ): RenderingServer.ViewportUpdateMode;

    /** Sets the clear mode of a viewport. */
    static viewport_set_clear_mode(
      viewport: RID,
      clear_mode: RenderingServer.ViewportClearMode,
    ): void;
    ...
    static viewport_set_environment_mode(
      viewport: RID,
    ...
    static viewport_set_snap_2d_transforms_to_pixel(
      viewport: RID,
      enabled: boolean,
    ): void;
     ...
     */
    static viewport_set_canvas_stacking(
      viewport: RID,
      canvas: RID,
      layer: int64,
      sublayer: int64,
    ...
    static viewport_set_transparent_background(
      viewport: RID,
      enabled: boolean,
    ): void;

    /** Sets the viewport's global transformation matrix. */
    static viewport_set_global_canvas_transform(
      viewport: RID,
      transform: Transform2D,
    ): void;
    ...
    static viewport_set_sdf_oversize_and_scale(
      viewport: RID,
     ...
     */
    static viewport_set_positional_shadow_atlas_size(
      viewport: RID,
      size: int64,
      use_16_bits?: boolean /* = false */,
    ): void;
    ...
    static viewport_set_positional_shadow_atlas_quadrant_subdivision(
      viewport: RID,
      quadrant: int64,
      subdivision: int64,
    ): void;
    ...
    static viewport_set_screen_space_aa(
      viewport: RID,
    ...
    static viewport_set_use_occlusion_culling(
      viewport: RID,
      enable: boolean,
    ): void;
    ...
    static viewport_set_occlusion_culling_build_quality(
     ...
     *
     */
    static viewport_get_render_info(
      viewport: RID,
    ...
    static viewport_set_debug_draw(
      viewport: RID,
    ...
    static viewport_set_measure_render_time(
      viewport: RID,
      enable: boolean,
    ): void;
     ...
     */
    static viewport_set_vrs_update_mode(
      viewport: RID,
      mode: RenderingServer.ViewportVRSUpdateMode,
    ): void;
    ...
    static compositor_effect_set_callback(
      effect: RID,
      callback_type: RenderingServer.CompositorEffectCallbackType,
      callback: Callable,
    ): void;

    /** Sets the flag ([param flag]) for this rendering effect to `true` or `false` ([param set]). */
    static compositor_effect_set_flag(
      effect: RID,
      flag: RenderingServer.CompositorEffectFlags,
      set: boolean,
    ): void;
    ...
    static compositor_set_compositor_effects(
      compositor: RID,
      effects: GArray<RID>,
    ): void;
    ...
    static environment_set_background(
      env: RID,
    ...
    static environment_set_bg_energy(
      env: RID,
      multiplier: float64,
    ...
    static environment_set_ambient_light(
      env: RID,
      color: Color,
      ambient?: RenderingServer.EnvironmentAmbientSource /* = 0 */,
      energy?: float64 /* = 1 */,
      sky_contribution?: float64 /* = 0 */,
      reflection_source?: RenderingServer.EnvironmentReflectionSource /* = 0 */,
    ): void;

    /** Configures glow for the specified environment RID. See `glow_*` properties in [Environment] for more information. */
    static environment_set_glow(
      env: RID,
      enable: boolean,
      levels: PackedFloat32Array | float32[],
      intensity: float64,
      strength: float64,
      mix: float64,
      bloom_threshold: float64,
      blend_mode: RenderingServer.EnvironmentGlowBlendMode,
    ...
    static environment_set_tonemap(
      env: RID,
      tone_mapper: RenderingServer.EnvironmentToneMapper,
      exposure: float64,
      white: float64,
    ): void;
    ...
    static environment_set_fog(
      ...
      sky_affect: float64,
      fog_mode?: RenderingServer.EnvironmentFogMode /* = 0 */,
    ): void;
    ...
    static environment_set_fog_depth(
      env: RID,
      curve: float64,
      begin: float64,
      end: float64,
    ...
    static environment_set_sdfgi(
      env: RID,
      enable: boolean,
      cascades: int64,
      min_cell_size: float64,
      y_scale: RenderingServer.EnvironmentSDFGIYScale,
    ...
    static environment_set_volumetric_fog(
      env: RID,
      enable: boolean,
      density: float64,
      albedo: Color,
    ...
    static environment_set_ssr_roughness_quality(
    ...
    static environment_set_ssao_quality(
    ...
    static environment_set_ssil_quality(
    ...
    static environment_set_sdfgi_ray_count(
      ray_count: RenderingServer.EnvironmentSDFGIRayCount,
    ): void;
    ...
    static environment_set_sdfgi_frames_to_converge(
    ...
    static environment_set_volumetric_fog_volume_size(
      size: int64,
      depth: int64,
    ): void;
     ...
     *  **Note:** [param size] should be a 2:1 aspect ratio for the generated panorama to have square pixels. For radiance maps, there is no point in using a height greater than [member Sky.radiance_size], as it won't increase detail. Irradiance maps only contain low-frequency data, so there is usually no point in going past a size of 128×64 pixels when saving an irradiance map.
     */
    static environment_bake_panorama(
      environment: RID,
      bake_irradiance: boolean,
      size: Vector2i,
    ): null | Image;
    ...
    static screen_space_roughness_limiter_set_active(
      enable: boolean,
      amount: float64,
      limit: float64,
    ): void;
    ...
    static sub_surface_scattering_set_quality(
    ...
    static sub_surface_scattering_set_scale(
      scale: float64,
      depth_scale: float64,
    ): void;
    ...
    static camera_attributes_set_dof_blur_quality(
    ...
    static camera_attributes_set_dof_blur_bokeh_shape(
      shape: RenderingServer.DOFBokehShape,
    ): void;

    /** Sets the parameters to use with the DOF blur effect. These parameters take on the same meaning as their counterparts in [CameraAttributesPractical]. */
    static camera_attributes_set_dof_blur(
     ...
     *
     */
    static camera_attributes_set_exposure(
      camera_attributes: RID,
      multiplier: float64,
    ...
    static camera_attributes_set_auto_exposure(
      camera_attributes: RID,
      enable: boolean,
    ...
    static scenario_set_fallback_environment(
      scenario: RID,
      environment: RID,
    ): void;
    ...
    static instance_set_pivot_data(
      instance: RID,
    ...
    static instance_set_blend_shape_weight(
      instance: RID,
      shape: int64,
      weight: float64,
    ): void;
     ...
     */
    static instance_geometry_set_transparency(
      instance: RID,
    ...
    static instance_set_extra_visibility_margin(
      instance: RID,
      margin: float64,
    ): void;
    ...
    static instance_geometry_set_flag(
      instance: RID,
    ...
    static instance_geometry_set_cast_shadows_setting(
      instance: RID,
      shadow_casting_setting: RenderingServer.ShadowCastingSetting,
    ): void;

    /** Sets a material that will override the material for all surfaces on the mesh associated with this instance. Equivalent to [member GeometryInstance3D.material_override]. */
    static instance_geometry_set_material_override(
      instance: RID,
      material: RID,
    ): void;
    ...
    static instance_geometry_set_material_overlay(
      instance: RID,
      material: RID,
    ): void;

    /** Sets the visibility range values for the given geometry instance. Equivalent to [member GeometryInstance3D.visibility_range_begin] and related properties. */
    static instance_geometry_set_visibility_range(
      instance: RID,
      min: float64,
      max: float64,
      min_margin: float64,
      max_margin: float64,
      fade_mode: RenderingServer.VisibilityRangeFadeMode,
    ): void;
    ...
    static instance_geometry_set_lightmap(
      instance: RID,
      lightmap: RID,
    ...
    static instance_geometry_set_lod_bias(
      instance: RID,
      lod_bias: float64,
    ): void;
    ...
    static instance_geometry_set_shader_parameter(
      instance: RID,
      parameter: StringName,
      value: any,
    ): void;
     ...
     */
    static instance_geometry_get_shader_parameter(
      instance: RID,
      parameter: StringName,
    ): any;
    ...
    static instance_geometry_get_shader_parameter_default_value(
      instance: RID,
      parameter: StringName,
    ): any;
    ...
    static instance_geometry_get_shader_parameter_list(
      instance: RID,
    ): GArray<GDictionary>;
     ...
     */
    static instances_cull_aabb(
      aabb: AABB,
      scenario?: RID /* = new RID() */,
    ): PackedInt64Array;

    /** Returns an array of object IDs intersecting with the provided 3D ray. Only 3D nodes that inherit from [VisualInstance3D] are considered, such as [MeshInstance3D] or [DirectionalLight3D]. Use [method @GlobalScope.instance_from_id] to obtain the actual nodes. A scenario RID must be provided, which is available in the [World3D] you want to query. This forces an update for all resources queued to update.
     *  **Warning:** This function is primarily intended for editor usage. For in-game use cases, prefer physics collision.
     */
    static instances_cull_ray(
      from: Vector3,
      to: Vector3,
      scenario?: RID /* = new RID() */,
    ): PackedInt64Array;
    ...
    static bake_render_uv2(
      base: RID,
      material_overrides: GArray<RID>,
      image_size: Vector2i,
    ): GArray<Image>;
     ...
     */
    static canvas_set_item_mirroring(
      canvas: RID,
      item: RID,
      mirroring: Vector2,
    ): void;
    ...
    static canvas_texture_set_channel(
      canvas_texture: RID,
    ...
    static canvas_texture_set_shading_parameters(
      canvas_texture: RID,
      base_color: Color,
      shininess: float64,
    ): void;
    ...
    static canvas_item_set_default_texture_filter(
      item: RID,
      filter: RenderingServer.CanvasItemTextureFilter,
    ): void;
    ...
    static canvas_item_set_default_texture_repeat(
      item: RID,
      repeat: RenderingServer.CanvasItemTextureRepeat,
    ): void;
    ...
    static canvas_item_set_visibility_layer(
      item: RID,
    ...
    static canvas_item_set_distance_field_mode(
      item: RID,
      enabled: boolean,
    ): void;
    ...
    static canvas_item_set_custom_rect(
      item: RID,
    ...
    static canvas_item_set_draw_behind_parent(
      item: RID,
      enabled: boolean,
    ): void;
    ...
    static canvas_item_add_polyline(
      item: RID,
      points: PackedVector2Array | Vector2[],
    ...
    static canvas_item_add_multiline(
      item: RID,
      points: PackedVector2Array | Vector2[],
      colors: PackedColorArray | Color[],
      width?: float64 /* = -1 */,
    ...
    static canvas_item_add_texture_rect(
      item: RID,
      rect: Rect2,
      texture: RID,
      tile?: boolean /* = false */,
    ...
    static canvas_item_add_msdf_texture_rect_region(
      item: RID,
      rect: Rect2,
      texture: RID,
      src_rect: Rect2,
      modulate?: Color /* = new Color(1, 1, 1, 1) */,
      outline_size?: int64 /* = 0 */,
      px_range?: float64 /* = 1 */,
      scale?: float64 /* = 1 */,
    ): void;

    /** See also [method CanvasItem.draw_lcd_texture_rect_region]. */
    static canvas_item_add_lcd_texture_rect_region(
      item: RID,
      rect: Rect2,
      texture: RID,
      src_rect: Rect2,
    ...
    static canvas_item_add_texture_rect_region(
      item: RID,
      rect: Rect2,
      texture: RID,
      src_rect: Rect2,
    ...
    static canvas_item_add_nine_patch(
      item: RID,
      rect: Rect2,
      source: Rect2,
      texture: RID,
      topleft: Vector2,
      bottomright: Vector2,
      x_axis_mode?: RenderingServer.NinePatchAxisMode /* = 0 */,
      y_axis_mode?: RenderingServer.NinePatchAxisMode /* = 0 */,
      draw_center?: boolean /* = true */,
      modulate?: Color /* = new Color(1, 1, 1, 1) */,
    ): void;

    /** Draws a 2D primitive on the [CanvasItem] pointed to by the [param item] [RID]. See also [method CanvasItem.draw_primitive]. */
    static canvas_item_add_primitive(
      item: RID,
      points: PackedVector2Array | Vector2[],
      colors: PackedColorArray | Color[],
     ...
     */
    static canvas_item_add_triangle_array(
      item: RID,
      indices: PackedInt32Array | int32[],
      points: PackedVector2Array | Vector2[],
      colors: PackedColorArray | Color[],
      uvs?: PackedVector2Array | Vector2[] /* = [] */,
      bones?: PackedInt32Array | int32[] /* = [] */,
      weights?: PackedFloat32Array | float32[] /* = [] */,
      texture?: RID /* = new RID() */,
      count?: int64 /* = -1 */,
    ): void;
    ...
    static canvas_item_add_multimesh(
      item: RID,
      mesh: RID,
      texture?: RID /* = new RID() */,
    ): void;
    ...
    static canvas_item_add_particles(
      item: RID,
      particles: RID,
      texture: RID,
    ): void;
    ...
    static canvas_item_add_set_transform(
      item: RID,
      transform: Transform2D,
    ): void;
    ...
    static canvas_item_add_animation_slice(
      item: RID,
    ...
    static canvas_item_set_sort_children_by_y(
      item: RID,
      enabled: boolean,
    ): void;
    ...
    static canvas_item_set_z_as_relative_to_parent(
      item: RID,
      enabled: boolean,
    ): void;

    /** Sets the [CanvasItem] to copy a rect to the backbuffer. */
    static canvas_item_set_copy_to_backbuffer(
      item: RID,
      enabled: boolean,
      rect: Rect2,
    ): void;
    ...
    static canvas_item_set_use_parent_material(
      item: RID,
      enabled: boolean,
    ): void;
    ...
    static canvas_item_set_instance_shader_parameter(
      instance: RID,
      parameter: StringName,
      value: any,
    ): void;
    ...
    static canvas_item_get_instance_shader_parameter(
      instance: RID,
      parameter: StringName,
    ): any;
     ...
     */
    static canvas_item_get_instance_shader_parameter_list(
      instance: RID,
    ): GArray<GDictionary>;
     ...
     */
    static canvas_item_set_visibility_notifier(
      item: RID,
      enable: boolean,
      area: Rect2,
      enter_callable: Callable,
     ...
     */
    static canvas_item_set_canvas_group_mode(
      item: RID,
      mode: RenderingServer.CanvasGroupMode,
      clear_margin?: float64 /* = 5 */,
      fit_empty?: boolean /* = false */,
      fit_margin?: float64 /* = 0 */,
      blur_mipmaps?: boolean /* = false */,
    ): void;
    ...
    static canvas_light_set_z_range(
      light: RID,
      min_z: int64,
      max_z: int64,
    ): void;
    ...
    static canvas_light_set_layer_range(
      light: RID,
      min_layer: int64,
      max_layer: int64,
    ): void;
    ...
    static canvas_light_set_item_shadow_cull_mask(
      light: RID,
      mask: int64,
    ): void;

    /** Sets the mode of the canvas light. */
    static canvas_light_set_mode(
      light: RID,
    ...
    static canvas_light_set_shadow_filter(
      light: RID,
    ...
    static canvas_light_set_blend_mode(
      light: RID,
    ...
    static canvas_light_set_interpolated(
      light: RID,
      interpolated: boolean,
    ): void;
     ...
     */
    static canvas_light_transform_physics_interpolation(
      light: RID,
      transform: Transform2D,
    ): void;
    ...
    static canvas_light_occluder_attach_to_canvas(
      occluder: RID,
      canvas: RID,
    ): void;

    /** Enables or disables light occluder. */
    static canvas_light_occluder_set_enabled(
      occluder: RID,
      enabled: boolean,
    ): void;
    ...
    static canvas_light_occluder_set_as_sdf_collision(
      occluder: RID,
      enable: boolean,
    ): void;

    /** Sets a light occluder's [Transform2D]. */
    static canvas_light_occluder_set_transform(
      occluder: RID,
      transform: Transform2D,
    ): void;

    /** The light mask. See [LightOccluder2D] for more information on light masks. */
    static canvas_light_occluder_set_light_mask(
      occluder: RID,
      mask: int64,
    ): void;

    /** If [param interpolated] is `true`, turns on physics interpolation for the light occluder. */
    static canvas_light_occluder_set_interpolated(
      occluder: RID,
      interpolated: boolean,
    ): void;
     ...
     */
    static canvas_light_occluder_reset_physics_interpolation(
      occluder: RID,
    ): void;
     ...
     */
    static canvas_light_occluder_transform_physics_interpolation(
      occluder: RID,
      transform: Transform2D,
    ): void;
    ...
    static canvas_occluder_polygon_set_shape(
      occluder_polygon: RID,
      shape: PackedVector2Array | Vector2[],
      closed: boolean,
    ): void;

    /** Sets an occluder polygon's cull mode. */
    static canvas_occluder_polygon_set_cull_mode(
      occluder_polygon: RID,
     ...
     */
    static global_shader_parameter_add(
      name: StringName,
    ...
    static global_shader_parameter_set_override(
      name: StringName,
      value: any,
    ): void;
     ...
     *  **Note:** [method global_shader_parameter_get] has a large performance penalty as the rendering thread needs to synchronize with the calling thread, which is slow. Do not use this method during gameplay to avoid stuttering. If you need to read values in a script after setting them, consider creating an autoload where you store the values you need to query at the same time you're setting them as global parameters.
     */
    static global_shader_parameter_get_type(
      name: StringName,
    ...
    static set_boot_image(
      image: Image,
      color: Color,
      scale: boolean,
      use_filter?: boolean /* = true */,
    ): void;
    ...
    static force_draw(
      swap_buffers?: boolean /* = true */,
      frame_step?: float64 /* = 0 */,
    ): void;
