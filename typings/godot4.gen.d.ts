...
declare module "godot" {
  ...
  class GraphEdit<Map extends NodePathMap = any> extends Control<Map> {
     ...
     *
     */
    /* gdvirtual */ _is_in_input_hotzone(
      in_node: Object,
      in_port: int64,
     ...
     *
     */
    /* gdvirtual */ _is_in_output_hotzone(
      in_node: Object,
      in_port: int64,
      mouse_position: Vector2,
    ): boolean;
    ...
    /* gdvirtual */ _get_connection_line(
     ...
     *
     */
    /* gdvirtual */ _is_node_hover_valid(
    ...
    readonly connection_from_empty: Signal<
      (to_node: StringName, to_port: int64, release_position: Vector2) => void
    >;

    /** Emitted at the beginning of a connection drag. */
    readonly connection_drag_started: Signal<
      (from_node: StringName, from_port: int64, is_output: boolean) => void
    >;
    ...
    readonly frame_rect_changed: Signal<
      (frame: GraphFrame, new_rect: Rect2) => void
    >;
     ...
     */
    readonly graph_elements_linked_to_frame_request: Signal<
      (elements: GArray, frame: StringName) => void
    >;
  ...
  class GraphNode<Map extends NodePathMap = any> extends GraphElement<Map> {
    ...
    set_slot(
      ...
      type_right: int64,
      color_right: Color,
      custom_icon_left?: Texture2D /* = undefined */,
      custom_icon_right?: Texture2D /* = undefined */,
      draw_stylebox?: boolean /* = true */,
    ): void;
  ...
  class GridMap<Map extends NodePathMap = any> extends Node3D<Map> {
     ...
     */
    make_baked_meshes(
      gen_lightmap_uv?: boolean /* = false */,
      lightmap_uv_texel_size?: float64 /* = 0.1 */,
    ): void;
  ...
  class HTTPClient extends RefCounted {
    ...
    request_raw(
      ...
      url: string,
      headers: PackedStringArray | string[],
      body: PackedByteArray | byte[] | ArrayBuffer,
    ): Error;
  ...
  class HTTPRequest<Map extends NodePathMap = any> extends Node<Map> {
    ...
    request(
      url: string,
      custom_headers?: PackedStringArray | string[] /* = [] */,
    ...
    request_raw(
      ...
      custom_headers?: PackedStringArray | string[] /* = [] */,
      method?: HTTPClient.Method /* = 0 */,
      request_data_raw?: PackedByteArray | byte[] | ArrayBuffer /* = [] */,
    ): Error;
  ...
  class Image extends Resource {
    ...
    resize_to_po2(
      ...
      interpolation?: Image.Interpolation /* = 1 */,
    ): void;
    ...
    compress(
      ...
      source?: Image.CompressSource /* = 0 */,
      astc_format?: Image.ASTCFormat /* = 0 */,
    ): Error;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapImageFormatLoaderExtension
    extends __NameMapImageFormatLoader {}
  ...
  class InputEvent extends Resource {
    ...
    xformed_by(
      xform: Transform2D,
      local_ofs?: Vector2 /* = Vector2.ZERO */,
    ): null | InputEvent;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapInputEventGesture
    extends __NameMapInputEventWithModifiers {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapInputEventMagnifyGesture
    extends __NameMapInputEventGesture {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapInputEventScreenDrag
    extends __NameMapInputEventFromWindow {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapInputEventScreenTouch
    extends __NameMapInputEventFromWindow {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapInputEventWithModifiers
    extends __NameMapInputEventFromWindow {}
  ...
  class InstancePlaceholder<Map extends NodePathMap = any> extends Node<Map> {
    ...
    create_instance(
      ...
      custom_scene?: PackedScene /* = undefined */,
    ): Node;
  ...
  class ItemList<Map extends NodePathMap = any> extends Control<Map> {
    ...
    readonly empty_clicked: Signal<
      (at_position: Vector2, mouse_button_index: int64) => void
    >;
    ...
    readonly item_clicked: Signal<
      (index: int64, at_position: Vector2, mouse_button_index: int64) => void
    >;
  ...
  class JSON extends Resource {
    ...
    static stringify(
      data: any,
      indent?: string /* = '' */,
      sort_keys?: boolean /* = true */,
      full_precision?: boolean /* = false */,
    ): string;
  ...
  class KinematicCollision3D extends RefCounted {
    ...
    get_angle(
      collision_index?: int64 /* = 0 */,
      up_direction?: Vector3 /* = Vector3.ZERO */,
    ): float64;
  ...
  class Logger extends RefCounted {
    ...
    /* gdvirtual */ _log_error(
      ...
      error_type: int64,
      script_backtraces: GArray<ScriptBacktrace>,
    ): void;
  ...
  class MainLoop extends Object {
    ...
    readonly on_request_permissions_result: Signal<
      (permission: string, granted: boolean) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class Mesh extends Resource {
    ...
    /* gdvirtual */ _surface_get_blend_shape_arrays(
      index: int64,
    ): GArray<GArray>;
    ...
    /* gdvirtual */ _surface_set_material(
      index: int64,
      material: Material,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapMeshConvexDecompositionSettings
  ...
  > extends GeometryInstance3D<Map> {
    ...
    create_multiple_convex_collisions(
      settings?: MeshConvexDecompositionSettings /* = undefined */,
    ): void;
  ...
  class MovieWriter extends Object {
    ...
    /* gdvirtual */ _write_frame(
      frame_image: Image,
      audio_frame_block: int64,
    ): Error;
  ...
  class MultiMesh extends Resource {
    ...
    set_buffer_interpolated(
      buffer_curr: PackedFloat32Array | float32[],
      buffer_prev: PackedFloat32Array | float32[],
    ): void;
  ...
  class MultiplayerAPIExtension extends MultiplayerAPI {
    ...
    /* gdvirtual */ _set_multiplayer_peer(
    ...
    /* gdvirtual */ _object_configuration_add(
      object: Object,
      configuration: any,
    ): Error;

    /** Callback for [method MultiplayerAPI.object_configuration_remove]. */
    /* gdvirtual */ _object_configuration_remove(
      object: Object,
      configuration: any,
    ): Error;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapMultiplayerPeerExtension
  ...
  class MultiplayerPeerExtension extends MultiplayerPeer {
    ...
    /* gdvirtual */ _put_packet_script(
      p_buffer: PackedByteArray | byte[] | ArrayBuffer,
    ): Error;
    ...
    /* gdvirtual */ _set_transfer_mode(
      p_mode: MultiplayerPeer.TransferMode,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapNavigationMeshSourceGeometryData2D
  ...
  class NavigationMeshSourceGeometryData2D extends Resource {
    ...
    append_traversable_outlines(
      traversable_outlines: GArray<PackedVector2Array>,
    ): void;
    ...
    append_obstruction_outlines(
      obstruction_outlines: GArray<PackedVector2Array>,
    ): void;

    /** Adds the outline points of a shape as traversable area. */
    add_traversable_outline(
      shape_outline: PackedVector2Array | Vector2[],
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapNavigationMeshSourceGeometryData3D
    extends __NameMapResource {}
  /** Container for parsed source geometry data used in navigation mesh baking.
   *
  ...
  class NavigationMeshSourceGeometryData3D extends Resource {
    ...
    append_arrays(
      vertices: PackedFloat32Array | float32[],
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapNavigationPathQueryParameters2D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapNavigationPathQueryParameters3D
    extends __NameMapRefCounted {}
  ...
  class NavigationPolygon extends Resource {
    ...
    add_outline_at_index(
      outline: PackedVector2Array | Vector2[],
      index: int64,
    ): void;
