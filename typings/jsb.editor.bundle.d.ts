declare module "jsb.editor.codegen" {
  ...
  export type OptionalTypeDescriptor<Descriptor extends GDictionary> =
    Descriptor extends GDictionary<infer T>
      ? GDictionary<
          T & {
            optional?: boolean;
          }
  ...
  export type ObjectLiteralTypeDescriptor = GDictionary<{
    ...
    properties?: GDictionary<
      Partial<Record<string, OptionalTypeDescriptor<TypeDescriptor>>>
    >;
    index?: GDictionary<{
      key: TypeDescriptor;
   ...
   */
  export type NodeTypeDescriptorPathMap = GDictionary<
    Partial<Record<string, TypeDescriptor>>
  >;
  ...
  export type CodeGenRequest =
    | ScriptNodeTypeDescriptorCodeGenRequest
  ...
  export class TypeDB {
    ...
    make_arg_default_value(
      method_info: GodotJsb.editor.MethodBind,
      index: number,
    ): string;
