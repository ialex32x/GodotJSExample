...
declare module "godot" {
  ...
  class NavigationServer2D extends Object {
    ...
    static region_set_navigation_layers(
      region: RID,
      navigation_layers: int64,
    ): void;
    ...
    static region_set_navigation_polygon(
      region: RID,
    ...
    static region_get_connection_pathway_start(
      region: RID,
      connection: int64,
    ): Vector2;
    ...
    static region_get_connection_pathway_end(
      region: RID,
      connection: int64,
    ): Vector2;
     ...
     */
    static region_get_random_point(
      region: RID,
      navigation_layers: int64,
      uniformly: boolean,
    ): Vector2;
    ...
    static link_set_navigation_layers(
      link: RID,
      navigation_layers: int64,
    ): void;
    ...
    static agent_set_time_horizon_agents(
      agent: RID,
    ...
    static agent_set_time_horizon_obstacles(
      agent: RID,
      time_horizon: float64,
    ): void;
    ...
    static obstacle_set_avoidance_enabled(
      obstacle: RID,
      enabled: boolean,
    ): void;
    ...
    static bake_from_source_geometry_data_async(
      navigation_polygon: NavigationPolygon,
      source_geometry_data: NavigationMeshSourceGeometryData2D,
      callback?: Callable /* = new Callable() */,
    ): void;
    ...
    static is_baking_navigation_polygon(
      navigation_polygon: NavigationPolygon,
    ): boolean;
     ...
     */
    static source_geometry_parser_set_callback(
      parser: RID,
      callback: Callable,
    ): void;
     ...
     */
    static simplify_path(
      path: PackedVector2Array | Vector2[],
      epsilon: float64,
    ): PackedVector2Array;
    ...
    static get_process_info(
      process_info: NavigationServer2D.ProcessInfo,
    ): int64;
  ...
  class NavigationServer3D extends Object {
     ...
     */
    static map_get_closest_point_to_segment(
      map: RID,
      start: Vector3,
      end: Vector3,
      use_collision?: boolean /* = false */,
    ): Vector3;
    ...
    static region_set_navigation_mesh(
      region: RID,
    ...
    static region_bake_navigation_mesh(
      navigation_mesh: NavigationMesh,
      root_node: Node,
    ): void;
     ...
     *  If [param use_collision] is `true`, a closest point test is only done when the segment intersects with the navigation mesh surface.
     */
    static region_get_closest_point_to_segment(
      region: RID,
      start: Vector3,
      end: Vector3,
      use_collision?: boolean /* = false */,
    ...
    static region_get_closest_point_normal(
      region: RID,
      to_point: Vector3,
    ): Vector3;
     ...
     */
    static simplify_path(
      path: PackedVector3Array | Vector3[],
      epsilon: float64,
    ): PackedVector3Array;
    ...
    /** Returns information about the current state of the NavigationServer. */
    static get_process_info(
      process_info: NavigationServer3D.ProcessInfo,
    ): int64;
  ...
  class PhysicsServer2D extends Object {
    ...
    static area_set_shape_transform(
      area: RID,
      shape_idx: int64,
    ...
    static area_set_shape_disabled(
      area: RID,
      shape_idx: int64,
      disabled: boolean,
    ): void;
    ...
    static body_set_shape_transform(
      body: RID,
      shape_idx: int64,
      transform: Transform2D,
    ): void;
    ...
    static body_set_shape_disabled(
      body: RID,
      shape_idx: int64,
      disabled: boolean,
    ): void;
    ...
    static body_set_shape_as_one_way_collision(
      body: RID,
      shape_idx: int64,
      enable: boolean,
      margin: float64,
     ...
     */
    static body_set_continuous_collision_detection_mode(
      body: RID,
      mode: PhysicsServer2D.CCDMode,
    ): void;

    /** Returns the body's continuous collision detection mode. */
    static body_get_continuous_collision_detection_mode(
      body: RID,
     ...
     *  [param position] is the offset from the body origin in global coordinates.
     */
    static body_add_constant_force(
      body: RID,
      force: Vector2,
      position?: Vector2 /* = Vector2.ZERO */,
    ): void;
     ...
     */
    static body_set_force_integration_callback(
      body: RID,
      callable: Callable,
      userdata?: any /* = <any> {} */,
    ): void;
    ...
    static body_test_motion(
      body: RID,
      parameters: PhysicsTestMotionParameters2D,
      result?: PhysicsTestMotionResult2D /* = undefined */,
    ): boolean;
    ...
    static joint_make_damped_spring(
      joint: RID,
      anchor_a: Vector2,
      anchor_b: Vector2,
      body_a: RID,
    ...
    static pin_joint_get_flag(
      joint: RID,
      flag: PhysicsServer2D.PinJointFlag,
    ): boolean;

    /** Sets a pin joint parameter. */
    static pin_joint_set_param(
      joint: RID,
    ...
    static pin_joint_get_param(
      joint: RID,
      param: PhysicsServer2D.PinJointParam,
    ): float64;

    /** Sets the value of the given damped spring joint parameter. */
    static damped_spring_joint_set_param(
      joint: RID,
    ...
    static damped_spring_joint_get_param(
      joint: RID,
      param: PhysicsServer2D.DampedSpringParam,
    ): float64;
  ...
  class PhysicsServer3D extends Object {
     ...
     */
    static body_set_enable_continuous_collision_detection(
      body: RID,
      enable: boolean,
    ): void;
    ...
    static body_set_axis_lock(
      body: RID,
      axis: PhysicsServer3D.BodyAxis,
      lock: boolean,
    ): void;
    static body_is_axis_locked(
      body: RID,
      axis: PhysicsServer3D.BodyAxis,
    ): boolean;
    ...
    static body_test_motion(
      ...
      result?: PhysicsTestMotionResult3D /* = undefined */,
    ): boolean;
    ...
    static soft_body_update_rendering_server(
      body: RID,
    ...
    static soft_body_set_simulation_precision(
      body: RID,
    ...
    static soft_body_set_shrinking_factor(
      body: RID,
    ...
    static soft_body_set_pressure_coefficient(
      body: RID,
    ...
    static soft_body_set_damping_coefficient(
      body: RID,
     ...
     */
    static soft_body_set_drag_coefficient(
      body: RID,
    ...
    static soft_body_get_point_global_position(
      body: RID,
      point_index: int64,
    ): Vector3;
     ...
     *  An impulse is time-independent! Applying an impulse every frame would result in a framerate-dependent force. For this reason, it should only be used when simulating one-time impacts (use the "_force" functions otherwise).
     */
    static soft_body_apply_point_impulse(
      body: RID,
      point_index: int64,
      impulse: Vector3,
    ): void;
    ...
    static soft_body_apply_point_force(
      body: RID,
      point_index: int64,
      force: Vector3,
    ): void;
    ...
    static hinge_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.HingeJointParam,
    ): float64;

    /** Sets a hinge joint flag. */
    static hinge_joint_set_flag(
      joint: RID,
    ...
    static hinge_joint_get_flag(
      joint: RID,
      flag: PhysicsServer3D.HingeJointFlag,
    ): boolean;
    static joint_make_slider(
      joint: RID,
      body_A: RID,
    ...
    /** Gets a slider joint parameter. */
    static slider_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.SliderJointParam,
    ): float64;
    static joint_make_cone_twist(
      joint: RID,
      body_A: RID,
      local_ref_A: Transform3D,
      body_B: RID,
    ...
    static cone_twist_joint_set_param(
      joint: RID,
    ...
    static cone_twist_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.ConeTwistJointParam,
    ): float64;
    ...
    static joint_make_generic_6dof(
      joint: RID,
      body_A: RID,
      local_ref_A: Transform3D,
      body_B: RID,
    ...
    static generic_6dof_joint_set_flag(
      joint: RID,
      axis: Vector3.Axis,
    ...
    static generic_6dof_joint_get_flag(
      joint: RID,
      axis: Vector3.Axis,
      flag: PhysicsServer3D.G6DOFJointAxisFlag,
    ): boolean;
  ...
  class XRServer extends Object {
     ...
     */
    static center_on_hmd(
      rotation_mode: XRServer.RotationMode,
      keep_height: boolean,
    ): void;
    ...
    static readonly tracker_added: Signal<
      (tracker_name: StringName, type: int64) => void
    >;
  ...
  class AStar2D extends RefCounted {
    ...
    get_point_path(
      from_id: int64,
      to_id: int64,
      allow_partial_path?: boolean /* = false */,
    ): PackedVector2Array;
  ...
  class Animation extends Resource {
    ...
    track_find_key(
      track_idx: int64,
      time: float64,
      find_mode?: Animation.FindMode /* = 0 */,
      limit?: boolean /* = false */,
      backward?: boolean /* = false */,
    ): int64;
    ...
    bezier_track_insert_key(
      ...
      time: float64,
      value: float64,
      in_handle?: Vector2 /* = Vector2.ZERO */,
      out_handle?: Vector2 /* = Vector2.ZERO */,
    ): int64;
    ...
    bezier_track_set_key_in_handle(
      ...
      key_idx: int64,
      in_handle: Vector2,
      balanced_value_time_ratio?: float64 /* = 1 */,
    ): void;
    ...
    optimize(
      allowed_velocity_err?: float64 /* = 0.01 */,
      allowed_angular_err?: float64 /* = 0.01 */,
      precision?: int64 /* = 3 */,
    ): void;
     ...
     */
    compress(
      page_size?: int64 /* = 8192 */,
      fps?: int64 /* = 120 */,
      split_tolerance?: float64 /* = 4 */,
    ): void;
  ...
  namespace __PathMappableDummyKeys {
    const AnimationLibrary: unique symbol;
  }
  /** Container for [Animation] resources.
   *
   *  @link https://docs.godotengine.org/en/4.5/classes/class_animationlibrary.html
   */
  class AnimationLibrary<AnimationName extends string = string>
    extends Resource
    implements
      PathMappable<
      ...
      >
  {
    [__PathMappableDummyKeys.AnimationLibrary]: Record<
      AnimationName,
      Animation
    >;
    constructor(identifier?: any);
    ...
    readonly animation_renamed: Signal<
      (name: StringName, to_name: StringName) => void
    >;
  ...
  namespace __PathMappableDummyKeys {
    const AnimationMixer: unique symbol;
  }
  ...
  class AnimationMixer<
      NodeMap extends NodePathMap = any,
      LibraryMap extends AnimationMixerPathMap = any,
    >
    extends Node<NodeMap>
    implements
      PathMappable<typeof __PathMappableDummyKeys.AnimationMixer, LibraryMap>
  {
    [__PathMappableDummyKeys.AnimationMixer]: LibraryMap;
    constructor(identifier?: any);
    /** A virtual function for processing after getting a key during playback. */
    /* gdvirtual */ _post_process_key_value(
      animation: Animation,
      track: int64,
      value: any,
      object_id: int64,
      object_sub_idx: int64,
    ): any;
     ...
     *
     */
    add_animation_library<Name extends keyof LibraryMap>(
      name: Name,
    ...
    rename_animation_library<
      FromName extends keyof LibraryMap,
      ToName extends ExtractValueKeys<LibraryMap, LibraryMap[FromName]>,
    >(name: FromName, newname: ToName): void;
     ...
     */
    get_animation_library<Name extends keyof LibraryMap>(
      name: Name,
    ): LibraryMap[Name];

    /** Returns the list of stored library keys. */
    get_animation_library_list(): keyof LibraryMap extends GAny
      ? GArray<keyof LibraryMap>
      : GArray;

    /** Returns `true` if the [AnimationMixer] stores an [Animation] with key [param name]. */
    has_animation<Name extends StaticAnimationMixerPath<LibraryMap>>(
      name: Name,
    ): boolean;

    /** Returns the [Animation] with the key [param name]. If the animation does not exist, `null` is returned and an error is logged. */
    get_animation<Name extends StaticAnimationMixerPath<LibraryMap>>(
      name: Name,
    ): ResolveAnimationMixerPath<LibraryMap, Name>;
    ...
    capture(
      name: StringName,
      duration: float64,
      trans_type?: Tween.TransitionType /* = 0 */,
      ease_type?: Tween.EaseType /* = 0 */,
    ): void;
    _reset(): void;
  ...
  class AnimationNode extends Resource {
    ...
    blend_animation(
      ...
      is_external_seeking: boolean,
      blend: float64,
      looped_flag?: Animation.LoopedFlag /* = 0 */,
    ): void;
    ...
    blend_node(
      ...
      is_external_seeking: boolean,
      blend: float64,
      filter?: AnimationNode.FilterAction /* = 0 */,
      sync?: boolean /* = true */,
    ...
    readonly animation_node_renamed: Signal<
      (object_id: int64, old_name: string, new_name: string) => void
    >;
    ...
    readonly animation_node_removed: Signal<
      (object_id: int64, name: string) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeAnimation
    extends __NameMapAnimationRootNode {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeBlendSpace1D
    extends __NameMapAnimationRootNode {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeBlendSpace2D
    extends __NameMapAnimationRootNode {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeBlendTree
    extends __NameMapAnimationRootNode {}
  ...
  class AnimationNodeExtension extends AnimationNode {
     ...
     */
    /* gdvirtual */ _process_animation_node(
      playback_info: PackedFloat64Array | float64[],
      test_only: boolean,
    ): PackedFloat32Array;
    ...
    static get_remaining_time(
      node_info: PackedFloat32Array | float32[],
      break_loop: boolean,
    ): float64;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeStateMachine
    extends __NameMapAnimationRootNode {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeStateMachinePlayback
    extends __NameMapResource {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeStateMachineTransition
    extends __NameMapResource {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAnimationNodeTransition
    extends __NameMapAnimationNodeSync {}
  ...
  > extends AnimationMixer<NodeMap, LibraryMap> {
     ...
     */
    play(
      name: StaticAnimationMixerPath<LibraryMap> /* = '' */,
      custom_blend?: float64 /* = -1 */,
      custom_speed?: float64 /* = 1 */,
      from_end?: boolean /* = false */,
    ): void;
    ...
    readonly animation_changed: Signal<
      (old_name: StringName, new_name: StringName) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class Area2D<Map extends NodePathMap = any> extends CollisionObject2D<Map> {
    ...
    readonly body_shape_entered: Signal<
      (
        body_rid: RID,
        body: Node2D,
        body_shape_index: int64,
        local_shape_index: int64,
      ) => void
    >;
  ...
  class ArrayMesh extends Mesh {
    ...
    add_surface_from_arrays(
      ...
      arrays: GArray,
      blend_shapes?: GArray<GArray> /* = [] */,
      lods?: GDictionary /* = new GDictionary() */,
      flags?: Mesh.ArrayFormat /* = 0 */,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectBandLimitFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectBandPassFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectHighPassFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectHighShelfFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectLowPassFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectLowShelfFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectNotchFilter
    extends __NameMapAudioEffectFilter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioEffectSpectrumAnalyzerInstance
    extends __NameMapAudioEffectInstance {}
  ...
  class AudioEffectSpectrumAnalyzerInstance extends AudioEffectInstance {
    ...
    get_magnitude_for_frequency_range(
      from_hz: float64,
      to_hz: float64,
      mode?: AudioEffectSpectrumAnalyzerInstance.MagnitudeMode /* = 1 */,
    ): Vector2;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamGeneratorPlayback
    extends __NameMapAudioStreamPlaybackResampled {}
  ...
  class AudioStreamInteractive extends AudioStream {
    ...
    add_transition(
      from_clip: int64,
      to_clip: int64,
      from_time: AudioStreamInteractive.TransitionFromTime,
      to_time: AudioStreamInteractive.TransitionToTime,
      fade_mode: AudioStreamInteractive.FadeMode,
      fade_beats: float64,
      use_filler_clip?: boolean /* = false */,
      filler_clip?: int64 /* = -1 */,
      hold_previous?: boolean /* = false */,
    ): void;
