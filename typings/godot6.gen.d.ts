...
declare module "godot" {
  ...
  interface __NameMapRDPipelineSpecializationConstant
  ...
  class RDShaderSPIRV extends Resource {
    ...
    set_stage_bytecode(
      stage: RenderingDevice.ShaderStage,
      bytecode: PackedByteArray | byte[] | ArrayBuffer,
    ): void;
    ...
    set bytecode_tesselation_control(
      value: PackedByteArray | byte[] | ArrayBuffer,
    );

    /** The SPIR-V bytecode for the tessellation evaluation shader stage. */
    get bytecode_tesselation_evaluation(): PackedByteArray;
    set bytecode_tesselation_evaluation(
      value: PackedByteArray | byte[] | ArrayBuffer,
    );
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapRenderSceneBuffersConfiguration
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapRenderSceneBuffersExtension
    extends __NameMapRenderSceneBuffers {}
  ...
  class RenderSceneBuffersExtension extends RenderSceneBuffers {
    ...
    /* gdvirtual */ _set_texture_mipmap_bias(
      texture_mipmap_bias: float64,
    ): void;

    /** Implement this in GDExtension to change the anisotropic filtering level. */
    /* gdvirtual */ _set_anisotropic_filtering_level(
      anisotropic_filtering_level: int64,
    ): void;
  ...
  class RenderSceneBuffersRD extends RenderSceneBuffers {
    ...
    create_texture(
      context: StringName,
      name: StringName,
      data_format: RenderingDevice.DataFormat,
      usage_bits: int64,
      texture_samples: RenderingDevice.TextureSamples,
      size: Vector2i,
      layers: int64,
      mipmaps: int64,
      unique: boolean,
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapRenderSceneDataExtension
    extends __NameMapRenderSceneData {}
  ...
  class RenderingDevice extends Object {
    ...
    texture_create_shared_from_slice(
      ...
      mipmap: int64,
      mipmaps?: int64 /* = 1 */,
      slice_type?: RenderingDevice.TextureSliceType /* = 0 */,
    ): RID;
    ...
    texture_create_from_extension(
      type: RenderingDevice.TextureType,
      format: RenderingDevice.DataFormat,
      samples: RenderingDevice.TextureSamples,
      usage_flags: RenderingDevice.TextureUsageBits,
      image: int64,
      width: int64,
      height: int64,
      depth: int64,
    ...
    framebuffer_format_create(
      attachments: GArray<RDAttachmentFormat>,
      view_count?: int64 /* = 1 */,
    ): int64;
    ...
    framebuffer_format_create_empty(
      samples?: RenderingDevice.TextureSamples /* = 0 */,
    ): int64;
    ...
    sampler_is_format_supported_for_filter(
      format: RenderingDevice.DataFormat,
      sampler_filter: RenderingDevice.SamplerFilter,
    ): boolean;
    ...
    vertex_buffer_create(
      size_bytes: int64,
      data?: PackedByteArray | byte[] | ArrayBuffer /* = [] */,
      creation_bits?: RenderingDevice.BufferCreationBits /* = 0 */,
    ): RID;
    ...
    vertex_array_create(
      vertex_count: int64,
      vertex_format: int64,
      src_buffers: GArray<RID>,
      offsets?: PackedInt64Array | int64[] /* = [] */,
    ): RID;
    ...
    index_buffer_create(
      ...
      data?: PackedByteArray | byte[] | ArrayBuffer /* = [] */,
      use_restart_indices?: boolean /* = false */,
      creation_bits?: RenderingDevice.BufferCreationBits /* = 0 */,
    ): RID;
    ...
    shader_create_from_bytecode(
      binary_data: PackedByteArray | byte[] | ArrayBuffer,
      placeholder_rid?: RID /* = new RID() */,
    ): RID;
    ...
    storage_buffer_create(
      size_bytes: int64,
      data?: PackedByteArray | byte[] | ArrayBuffer /* = [] */,
      usage?: RenderingDevice.StorageBufferUsage /* = 0 */,
      creation_bits?: RenderingDevice.BufferCreationBits /* = 0 */,
    ): RID;
    ...
    render_pipeline_create(
      ...
      dynamic_state_flags?: RenderingDevice.PipelineDynamicStateFlags /* = 0 */,
      for_render_pass?: int64 /* = 0 */,
      specialization_constants?: GArray<RDPipelineSpecializationConstant> /* = [] */,
    ): RID;
    ...
    draw_list_begin_for_screen(
      screen?: int64 /* = 0 */,
      clear_color?: Color /* = new Color(0, 0, 0, 1) */,
    ): int64;
    ...
    draw_list_begin(
      framebuffer: RID,
      draw_flags?: RenderingDevice.DrawFlags /* = 0 */,
      clear_color_values?: PackedColorArray | Color[] /* = [] */,
      clear_depth_value?: float64 /* = 1 */,
      clear_stencil_value?: int64 /* = 0 */,
      region?: Rect2 /* = new Rect2(0, 0, 0, 0) */,
      breadcrumb?: int64 /* = 0 */,
    ): int64;
    ...
    draw_list_begin_split(
      framebuffer: RID,
      splits: int64,
      initial_color_action: RenderingDevice.InitialAction,
      final_color_action: RenderingDevice.FinalAction,
      initial_depth_action: RenderingDevice.InitialAction,
      final_depth_action: RenderingDevice.FinalAction,
      clear_color_values?: PackedColorArray | Color[] /* = [] */,
      clear_depth?: float64 /* = 1 */,
      clear_stencil?: int64 /* = 0 */,
      region?: Rect2 /* = new Rect2(0, 0, 0, 0) */,
      storage_textures?: GArray<RID> /* = [] */,
    ): PackedInt64Array;
    ...
    draw_list_draw(
      ...
      use_indices: boolean,
      instances: int64,
      procedural_vertex_count?: int64 /* = 0 */,
    ): void;
    ...
    barrier(
      from?: RenderingDevice.BarrierMask /* = 32767 */,
      to?: RenderingDevice.BarrierMask /* = 32767 */,
    ): void;
  ...
  class Resource extends RefCounted {
     ...
     */
    duplicate_deep(
      deep_subresources_mode?: Resource.DeepDuplicateMode /* = 1 */,
    ): null | Resource;
  ...
  class ResourceFormatLoader extends RefCounted {
     ...
     */
    /* gdvirtual */ _rename_dependencies(
      path: string,
      renames: GDictionary,
    ): Error;
  ...
  class ResourceFormatSaver extends RefCounted {
    ...
    /* gdvirtual */ _get_recognized_extensions(
      resource: Resource,
    ): PackedStringArray;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterCSVTranslation
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterDynamicFont
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterImageFont
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterLayeredTexture
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterOggVorbis
    extends __NameMapResourceImporter {}
  ...
  class ResourceImporterOggVorbis extends ResourceImporter {
    ...
    static load_from_buffer(
      stream_data: PackedByteArray | byte[] | ArrayBuffer,
    ): null | AudioStreamOggVorbis;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterShaderFile
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterTexture
    extends __NameMapResourceImporter {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapResourceImporterTextureAtlas
    extends __NameMapResourceImporter {}
  ...
  class RichTextLabel<Map extends NodePathMap = any> extends Control<Map> {
    ...
    add_hr(
      ...
      width_in_percent?: boolean /* = true */,
      height_in_percent?: boolean /* = false */,
    ): void;
    ...
    add_image(
      ...
      pad?: boolean /* = false */,
      tooltip?: string /* = '' */,
      width_in_percent?: boolean /* = false */,
      height_in_percent?: boolean /* = false */,
      alt_text?: string /* = '' */,
    ): void;
    ...
    update_image(
      key: any,
      mask: RichTextLabel.ImageUpdateMask,
      image: Texture2D,
      width?: int64 /* = 0 */,
      height?: int64 /* = 0 */,
      color?: Color /* = new Color(1, 1, 1, 1) */,
    ...
    push_paragraph(
      ...
      base_direction?: Control.TextDirection /* = 0 */,
      language?: string /* = '' */,
      st_parser?: TextServer.StructuredTextParser /* = 0 */,
      justification_flags?: TextServer.JustificationFlag /* = 163 */,
    ...
    push_meta(
      data: any,
      underline_mode?: RichTextLabel.MetaUnderline /* = 1 */,
      tooltip?: string /* = '' */,
    ): void;
    ...
    push_table(
      columns: int64,
      inline_align?: InlineAlignment /* = 0 */,
      align_to_row?: int64 /* = -1 */,
      name?: string /* = '' */,
    ): void;
    ...
    push_dropcap(
      ...
      outline_color?: Color /* = new Color(0, 0, 0, 0) */,
    ): void;
    ...
    parse_expressions_for_values(
      expressions: PackedStringArray | string[],
    ): GDictionary;
  ...
  class SceneMultiplayer extends MultiplayerAPI {
    ...
    send_bytes(
      ...
      id?: int64 /* = 0 */,
      mode?: MultiplayerPeer.TransferMode /* = 2 */,
      channel?: int64 /* = 0 */,
    ): Error;
  ...
  class SceneTree extends MainLoop {
    ...
    create_timer(
      time_sec: float64,
      process_always?: boolean /* = true */,
      process_in_physics?: boolean /* = false */,
      ignore_time_scale?: boolean /* = false */,
    ): SceneTreeTimer;
  ...
  > extends ConfirmationDialog<Map> {
    ...
    config(
      inherits: string,
      path: string,
      built_in_enabled?: boolean /* = true */,
      load_enabled?: boolean /* = true */,
    ): void;
  ...
  class ScriptLanguageExtension extends ScriptLanguage {
    ...
    /* gdvirtual */ _make_template(
      template: string,
      class_name: string,
      base_class_name: string,
    ): null | Script;
    /* gdvirtual */ _get_built_in_templates(
      object: StringName,
    ): GArray<GDictionary>;
    ...
    /* gdvirtual */ _complete_code(
      code: string,
      path: string,
      owner: Object,
    ): GDictionary;
    /* gdvirtual */ _lookup_code(
      code: string,
      symbol: string,
      path: string,
      owner: Object,
    ): GDictionary;
    /* gdvirtual */ _auto_indent_code(
      code: string,
      from_line: int64,
      to_line: int64,
    ): string;
    /* gdvirtual */ _add_global_constant(name: StringName, value: any): void;
    /* gdvirtual */ _add_named_global_constant(
      name: StringName,
      value: any,
    ): void;
    ...
    /* gdvirtual */ _debug_get_stack_level_locals(
      level: int64,
      max_subitems: int64,
      max_depth: int64,
    ): GDictionary;
    /* gdvirtual */ _debug_get_stack_level_members(
      level: int64,
      max_subitems: int64,
      max_depth: int64,
    ): GDictionary;
    /* gdvirtual */ _debug_get_stack_level_instance(level: int64): int64;
    /* gdvirtual */ _debug_get_globals(
      max_subitems: int64,
      max_depth: int64,
    ): GDictionary;
    /* gdvirtual */ _debug_parse_stack_level_expression(
      level: int64,
      expression: string,
      max_subitems: int64,
      max_depth: int64,
    ...
    /* gdvirtual */ _reload_scripts(
      scripts: GArray,
      soft_reload: boolean,
    ): void;
    /* gdvirtual */ _reload_tool_script(
      script: Script,
      soft_reload: boolean,
    ): void;
    /* gdvirtual */ _get_recognized_extensions(): PackedStringArray;
    ...
    /* gdvirtual */ _profiling_get_accumulated_data(
      info_array: int64,
      info_max: int64,
    ): int64;
    /* gdvirtual */ _profiling_get_frame_data(
      info_array: int64,
      info_max: int64,
    ): int64;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DCCDIK
    extends __NameMapSkeletonModification2D {}
  ...
  class SkeletonModification2DCCDIK extends SkeletonModification2D {
    ...
    set_ccdik_joint_bone2d_node(
      joint_idx: int64,
      bone2d_nodepath: NodePath | string,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DFABRIK
    extends __NameMapSkeletonModification2D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DJiggle
    extends __NameMapSkeletonModification2D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DLookAt
    extends __NameMapSkeletonModification2D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DPhysicalBones
    extends __NameMapSkeletonModification2D {}
  ...
  class SkeletonModification2DPhysicalBones extends SkeletonModification2D {
    ...
    set_physical_bone_node(
      joint_idx: int64,
      physicalbone2d_node: NodePath | string,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DStackHolder
    extends __NameMapSkeletonModification2D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSkeletonModification2DTwoBoneIK
    extends __NameMapSkeletonModification2D {}
  ...
  class SkeletonProfile extends Resource {
    ...
    set_tail_direction(
      bone_idx: int64,
      tail_direction: SkeletonProfile.TailDirection,
    ): void;
  ...
  class SoftBody3D<Map extends NodePathMap = any> extends MeshInstance3D<Map> {
    ...
    set_point_pinned(
      point_index: int64,
      pinned: boolean,
      attachment_path?: NodePath | string /* = '' */,
      insert_at?: int64 /* = -1 */,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSpringBoneCollisionCapsule3D
    extends __NameMapSpringBoneCollision3D {}
  ...
  class SpringBoneCollisionCapsule3D<
    Map extends NodePathMap = any,
  > extends SpringBoneCollision3D<Map> {
    constructor(identifier?: any);
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSpringBoneCollisionPlane3D
    extends __NameMapSpringBoneCollision3D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSpringBoneCollisionSphere3D
    extends __NameMapSpringBoneCollision3D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapSpringBoneSimulator3D
  ...
  > extends SkeletonModifier3D<Map> {
    ...
    set_end_bone_direction(
      index: int64,
      bone_direction: SpringBoneSimulator3D.BoneDirection,
    ): void;
    ...
    set_center_from(
      index: int64,
      center_from: SpringBoneSimulator3D.CenterFrom,
    ): void;
