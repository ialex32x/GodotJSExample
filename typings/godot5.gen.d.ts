...
declare module "godot" {
   ...
   */
  class Node<Map extends NodePathMap = any>
    extends Object
    implements PathMappable<typeof __PathMappableDummyKeys.Node, Map>
  {
    ...
    add_sibling(
      sibling: Node,
      force_readable_name?: boolean /* = false */,
    ): void;
     ...
     */
    add_child(
      node: NodePathMapChild<Map>,
      force_readable_name?: boolean /* = false */,
      internal?: Node.InternalMode /* = 0 */,
    ): void;
    ...
    reparent(
      new_parent: Node,
      keep_global_transform?: boolean /* = true */,
    ): void;
     ...
     *
     */
    get_node<Path extends StaticNodePath<Map>, Default = never>(
      path: Path,
    ): ResolveNodePath<Map, Path, Default>;
    ...
    get_node_or_null<
      Path extends StaticNodePath<Map, undefined | Node>,
      Default = null,
    >(path: Path): null | ResolveNodePath<Map, Path, Default, undefined | Node>;
  ...
  class Object {
     ...
     */
    call<M extends GodotNames<this>>(
      method: M,
      ...args: ResolveGodotNameParameters<this, NoInfer<M>>
     ...
     *
     */
    call_deferred<M extends GodotNames<this>>(
      method: M,
      ...args: ResolveGodotNameParameters<this, NoInfer<M>>
    ): void;
     ...
     *  **Note:** In C#, [param property] must be in snake_case when referring to built-in Godot properties. Prefer using the names exposed in the `PropertyName` class to avoid allocating a new [StringName] on each call.
     */
    set_deferred<P extends GodotNames<this>>(
      property: P,
      value: ResolveGodotNameValue<this, NoInfer<P>>,
    ): void;
     ...
     *  **Note:** In C#, [param method] must be in snake_case when referring to built-in Godot methods. Prefer using the names exposed in the `MethodName` class to avoid allocating a new [StringName] on each call.
     */
    callv<M extends GodotNames<this>>(
      method: M,
      argArray: GArray<ResolveGodotNameParameters<this, NoInfer<M>>>,
    ): ResolveGodotReturnType<this, NoInfer<M>>;
  ...
  class OpenXRAPIExtension extends RefCounted {
    ...
    register_composition_layer_provider(
      extension: OpenXRExtensionWrapper,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRActionBindingModifier
    extends __NameMapOpenXRBindingModifier {}
  ...
  class OpenXRActionMap extends Resource {
    ...
    add_interaction_profile(
      interaction_profile: OpenXRInteractionProfile,
    ): void;

    /** Remove an interaction profile. */
    remove_interaction_profile(
      interaction_profile: OpenXRInteractionProfile,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRAnalogThresholdModifier
    extends __NameMapOpenXRActionBindingModifier {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRBindingModifierEditor
    extends __NameMapPanelContainer {}
  ...
  > extends PanelContainer<Map> {
    ...
    setup(
      ...
      binding_modifier: OpenXRBindingModifier,
    ): void;

    /** Signal emitted when the user presses the delete binding modifier button for this modifier. */
    readonly binding_modifier_removed: Signal<
      (binding_modifier_editor: Object) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRCompositionLayerCylinder
    extends __NameMapOpenXRCompositionLayer {}
  ...
  class OpenXRCompositionLayerCylinder<
    Map extends NodePathMap = any,
  > extends OpenXRCompositionLayer<Map> {
    constructor(identifier?: any);
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRCompositionLayerEquirect
    extends __NameMapOpenXRCompositionLayer {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRCompositionLayerQuad
    extends __NameMapOpenXRCompositionLayer {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRDpadBindingModifier
    extends __NameMapOpenXRIPBindingModifier {}
  ...
  class OpenXRExtensionWrapper extends Object {
    ...
    /* gdvirtual */ _set_system_properties_and_get_next_pointer(
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures when the OpenXR instance is created. */
    /* gdvirtual */ _set_instance_create_info_and_get_next_pointer(
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures when the OpenXR session is created. */
    /* gdvirtual */ _set_session_create_and_get_next_pointer(
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures when creating OpenXR swapchains. */
    /* gdvirtual */ _set_swapchain_create_info_and_get_next_pointer(
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures when each hand tracker is created. */
    /* gdvirtual */ _set_hand_joint_locations_and_get_next_pointer(
      hand_index: int64,
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures to the projection view of the given [param view_index]. */
    /* gdvirtual */ _set_projection_views_and_get_next_pointer(
      view_index: int64,
      next_pointer: int64,
    ): int64;
     ...
     */
    /* gdvirtual */ _set_frame_wait_info_and_get_next_pointer(
      next_pointer: int64,
    ): int64;
     ...
     *  This will only be called if the extension previously registered itself with [method OpenXRAPIExtension.register_frame_info_extension].
     */
    /* gdvirtual */ _set_frame_end_info_and_get_next_pointer(
      next_pointer: int64,
    ): int64;
     ...
     *  This will only be called if the extension previously registered itself with [method OpenXRAPIExtension.register_frame_info_extension].
     */
    /* gdvirtual */ _set_view_locate_info_and_get_next_pointer(
      next_pointer: int64,
    ): int64;

    /** Adds additional data structures to `XrReferenceSpaceCreateInfo`. */
    /* gdvirtual */ _set_reference_space_create_info_and_get_next_pointer(
      reference_space_type: int64,
      next_pointer: int64,
    ): int64;
     ...
     */
    /* gdvirtual */ _set_viewport_composition_layer_and_get_next_pointer(
      layer: int64,
      property_values: GDictionary,
      next_pointer: int64,
    ): int64;
     ...
     *  [param layer] is a pointer to an `XrCompositionLayerBaseHeader` struct.
     */
    /* gdvirtual */ _on_viewport_composition_layer_destroyed(
      layer: int64,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRExtensionWrapperExtension
    extends __NameMapOpenXRExtensionWrapper {}
  /** Allows implementing OpenXR extensions with GDExtension.
   *
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRFutureExtension
    extends __NameMapOpenXRExtensionWrapper {}
  ...
  class OpenXRFutureExtension extends OpenXRExtensionWrapper {
    ...
    register_future(
      future: int64,
      on_success?: Callable /* = new Callable() */,
    ): null | OpenXRFutureResult;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRIPBindingModifier
    extends __NameMapOpenXRBindingModifier {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRInteractionProfileEditor
    extends __NameMapOpenXRInteractionProfileEditorBase {}
  ...
  class OpenXRInteractionProfileEditor<
    Map extends NodePathMap = any,
  > extends OpenXRInteractionProfileEditorBase<Map> {
    constructor(identifier?: any);
    /** @deprecated Internal use. Does not exist at runtime. */
    __godotNameMap: __NameMapOpenXRInteractionProfileEditor;
  }
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRInteractionProfileEditorBase
    extends __NameMapHBoxContainer {}
  ...
  class OpenXRInterface extends XRInterface {
    ...
    set_motion_range(
      ...
      motion_range: OpenXRInterface.HandMotionRange,
    ): void;
    ...
    get_hand_tracking_source(
      hand: OpenXRInterface.Hand,
    ): OpenXRInterface.HandTrackedSource;
    ...
    readonly cpu_level_changed: Signal<
      (sub_domain: int64, from_level: int64, to_level: int64) => void
    >;

    /** Informs the device GPU performance level has changed in the specified subdomain. */
    readonly gpu_level_changed: Signal<
      (sub_domain: int64, from_level: int64, to_level: int64) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapOpenXRRenderModelExtension
    extends __NameMapOpenXRExtensionWrapper {}
  ...
  class OpenXRRenderModelExtension extends OpenXRExtensionWrapper {
    ...
    readonly render_model_top_level_path_changed: Signal<
      (render_model: RID) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  > extends Node3D<Map> {
    ...
    readonly render_model_added: Signal<
      (render_model: OpenXRRenderModel) => void
    >;

    /** Emitted when a render model child node is about to be removed from this node. */
    readonly render_model_removed: Signal<
      (render_model: OpenXRRenderModel) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class PCKPacker extends RefCounted {
    ...
    pck_start(
      ...
      encrypt_directory?: boolean /* = false */,
    ): Error;
  ...
  class ParallaxBackground<
    Map extends NodePathMap = any,
  > extends CanvasLayer<Map> {
    constructor(identifier?: any);
    _camera_moved(
      _unnamed_arg0: Transform2D,
      _unnamed_arg1: Vector2,
      _unnamed_arg2: Vector2,
    ): void;
  ...
  class ParticleProcessMaterial extends Material {
    ...
    set_param_min(
      param: ParticleProcessMaterial.Parameter,
      value: float64,
    ): void;
    ...
    set_particle_flag(
      particle_flag: ParticleProcessMaterial.ParticleFlags,
      enable: boolean,
    ): void;
  ...
  class PathFollow3D<Map extends NodePathMap = any> extends Node3D<Map> {
    ...
    static correct_posture(
      transform: Transform3D,
      rotation_mode: PathFollow3D.RotationMode,
    ): Transform3D;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicalBoneSimulator3D
    extends __NameMapSkeletonModifier3D {}
  ...
  class PhysicalBoneSimulator3D<
    Map extends NodePathMap = any,
  > extends SkeletonModifier3D<Map> {
    constructor(identifier?: any);
  ...
  > extends CollisionObject2D<Map> {
    ...
    move_and_collide(
      ...
      safe_margin?: float64 /* = 0.08 */,
      recovery_as_collision?: boolean /* = false */,
    ): null | KinematicCollision2D;
    ...
    test_move(
      from: Transform2D,
      motion: Vector2,
      collision?: KinematicCollision2D /* = undefined */,
      safe_margin?: float64 /* = 0.08 */,
      recovery_as_collision?: boolean /* = false */,
    ): boolean;
  ...
  > extends CollisionObject3D<Map> {
    ...
    move_and_collide(
      motion: Vector3,
      test_only?: boolean /* = false */,
      safe_margin?: float64 /* = 0.001 */,
      recovery_as_collision?: boolean /* = false */,
      max_collisions?: int64 /* = 1 */,
    ): null | KinematicCollision3D;
    ...
    test_move(
      from: Transform3D,
      motion: Vector3,
      collision?: KinematicCollision3D /* = undefined */,
      safe_margin?: float64 /* = 0.001 */,
      recovery_as_collision?: boolean /* = false */,
      max_collisions?: int64 /* = 1 */,
    ): boolean;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsDirectBodyState2DExtension
    extends __NameMapPhysicsDirectBodyState2D {}
  ...
  class PhysicsDirectBodyState2DExtension extends PhysicsDirectBodyState2D {
    ...
    /* gdvirtual */ _get_velocity_at_local_position(
    ...
    /* gdvirtual */ _get_contact_local_velocity_at_position(
      contact_idx: int64,
    ): Vector2;
    ...
    /* gdvirtual */ _get_contact_collider_object(
      contact_idx: int64,
    ): null | Object;
    ...
    /* gdvirtual */ _get_contact_collider_velocity_at_position(
      contact_idx: int64,
    ): Vector2;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsDirectBodyState3DExtension
    extends __NameMapPhysicsDirectBodyState3D {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsDirectSpaceState2DExtension
    extends __NameMapPhysicsDirectSpaceState2D {}
  ...
  class PhysicsDirectSpaceState2DExtension extends PhysicsDirectSpaceState2D {
    ...
    /* gdvirtual */ _intersect_point(
      position: Vector2,
      canvas_instance_id: int64,
      collision_mask: int64,
      collide_with_bodies: boolean,
      collide_with_areas: boolean,
      results: int64,
    ...
    /* gdvirtual */ _cast_motion(
      ...
      collide_with_areas: boolean,
      closest_safe: int64,
      closest_unsafe: int64,
    ): boolean;
    /* gdvirtual */ _collide_shape(
      shape_rid: RID,
      transform: Transform2D,
      motion: Vector2,
      margin: float64,
  ...
  class PhysicsDirectSpaceState3D extends Object {
     ...
     */
    intersect_point(
      parameters: PhysicsPointQueryParameters3D,
      max_results?: int64 /* = 32 */,
    ): GArray<GDictionary>;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsDirectSpaceState3DExtension
    extends __NameMapPhysicsDirectSpaceState3D {}
  ...
  class PhysicsDirectSpaceState3DExtension extends PhysicsDirectSpaceState3D {
    ...
    /* gdvirtual */ _get_closest_point_to_object_volume(
      object: RID,
      point: Vector3,
    ): Vector3;
    is_body_excluded_from_query(body: RID): boolean;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsPointQueryParameters2D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsPointQueryParameters3D
    extends __NameMapRefCounted {}
  ...
  class PhysicsRayQueryParameters2D extends RefCounted {
    ...
    static create(
      from: Vector2,
      to: Vector2,
      collision_mask?: int64 /* = 4294967295 */,
      exclude?: GArray<RID> /* = [] */,
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsServer2DExtension
    extends __NameMapPhysicsServer2D {}
  ...
  class PhysicsServer2DExtension extends PhysicsServer2D {
     ...
     */
    /* gdvirtual */ _shape_set_custom_solver_bias(
      shape: RID,
      bias: float64,
    ): void;
    ...
    /* gdvirtual */ _space_get_direct_state(
      space: RID,
    ): null | PhysicsDirectSpaceState2D;
     ...
     */
    /* gdvirtual */ _space_set_debug_contacts(
      space: RID,
      max_contacts: int64,
    ): void;
    ...
    /* gdvirtual */ _area_set_shape_transform(
      area: RID,
      shape_idx: int64,
      transform: Transform2D,
    ): void;
    ...
    /* gdvirtual */ _area_get_shape_transform(
      area: RID,
      shape_idx: int64,
    ): Transform2D;
    ...
    /* gdvirtual */ _area_set_monitorable(
      area: RID,
      monitorable: boolean,
    ): void;
    ...
    /* gdvirtual */ _area_set_monitor_callback(
      area: RID,
      callback: Callable,
    ): void;

    /** Overridable version of [method PhysicsServer2D.area_set_area_monitor_callback]. */
    /* gdvirtual */ _area_set_area_monitor_callback(
      area: RID,
      callback: Callable,
    ): void;
    ...
    /* gdvirtual */ _body_set_shape_transform(
      body: RID,
      shape_idx: int64,
      transform: Transform2D,
    ): void;
    ...
    /* gdvirtual */ _body_get_shape_transform(
      body: RID,
      shape_idx: int64,
    ): Transform2D;

    /** Overridable version of [method PhysicsServer2D.body_set_shape_disabled]. */
    /* gdvirtual */ _body_set_shape_disabled(
      body: RID,
      shape_idx: int64,
      disabled: boolean,
    ): void;
    ...
    /* gdvirtual */ _body_set_shape_as_one_way_collision(
      body: RID,
      shape_idx: int64,
      enable: boolean,
      margin: float64,
    ...
    /* gdvirtual */ _body_set_collision_priority(
      body: RID,
      priority: float64,
    ): void;
    ...
    /* gdvirtual */ _body_add_constant_central_force(
      body: RID,
      force: Vector2,
    ): void;

    /** Overridable version of [method PhysicsServer2D.body_add_constant_force]. */
    /* gdvirtual */ _body_add_constant_force(
      body: RID,
      force: Vector2,
      position: Vector2,
    ): void;
    ...
    /* gdvirtual */ _body_set_max_contacts_reported(
      body: RID,
      amount: int64,
    ): void;
    ...
    /* gdvirtual */ _body_set_omit_force_integration(
      body: RID,
      enable: boolean,
    ): void;
     ...
     */
    /* gdvirtual */ _body_set_state_sync_callback(
      body: RID,
      callable: Callable,
    ): void;

    /** Overridable version of [method PhysicsServer2D.body_set_force_integration_callback]. */
    /* gdvirtual */ _body_set_force_integration_callback(
      body: RID,
      callable: Callable,
      userdata: any,
    ): void;
    ...
    /* gdvirtual */ _body_get_direct_state(
      body: RID,
    ): null | PhysicsDirectBodyState2D;
    ...
    /* gdvirtual */ _joint_make_damped_spring(
      joint: RID,
      anchor_a: Vector2,
      anchor_b: Vector2,
      body_a: RID,
    ...
    /* gdvirtual */ _damped_spring_joint_get_param(
      joint: RID,
      param: PhysicsServer2D.DampedSpringParam,
    ): float64;
    ...
    /* gdvirtual */ _get_process_info(
      process_info: PhysicsServer2D.ProcessInfo,
    ): int64;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsServer3DExtension
    extends __NameMapPhysicsServer3D {}
  ...
  class PhysicsServer3DExtension extends PhysicsServer3D {
    ...
    /* gdvirtual */ _space_get_direct_state(
      space: RID,
    ): null | PhysicsDirectSpaceState3D;
    /* gdvirtual */ _space_set_debug_contacts(
      space: RID,
      max_contacts: int64,
    ): void;
    ...
    /* gdvirtual */ _body_attach_object_instance_id(body: RID, id: int64): void;
    /* gdvirtual */ _body_get_object_instance_id(body: RID): int64;
    /* gdvirtual */ _body_set_enable_continuous_collision_detection(
      body: RID,
      enable: boolean,
    ): void;
    /* gdvirtual */ _body_is_continuous_collision_detection_enabled(
      body: RID,
    ): boolean;
    /* gdvirtual */ _body_set_collision_layer(body: RID, layer: int64): void;
    /* gdvirtual */ _body_get_collision_layer(body: RID): int64;
    ...
    /* gdvirtual */ _body_set_axis_lock(
      body: RID,
      axis: PhysicsServer3D.BodyAxis,
      lock: boolean,
    ): void;
    /* gdvirtual */ _body_is_axis_locked(
      body: RID,
      axis: PhysicsServer3D.BodyAxis,
    ): boolean;
    /* gdvirtual */ _body_add_collision_exception(
    ...
    /* gdvirtual */ _body_get_direct_state(
      body: RID,
    ): null | PhysicsDirectBodyState3D;
    /* gdvirtual */ _soft_body_create(): RID;
    /* gdvirtual */ _soft_body_update_rendering_server(
      body: RID,
    ...
    /* gdvirtual */ _soft_body_set_collision_layer(
      body: RID,
      layer: int64,
    ): void;
    ...
    /* gdvirtual */ _soft_body_add_collision_exception(
      body: RID,
      body_b: RID,
    ): void;
    /* gdvirtual */ _soft_body_remove_collision_exception(
      body: RID,
      body_b: RID,
    ): void;
    /* gdvirtual */ _soft_body_get_collision_exceptions(body: RID): GArray<RID>;
    /* gdvirtual */ _soft_body_set_state(
      body: RID,
      state: PhysicsServer3D.BodyState,
      variant: any,
    ): void;
    /* gdvirtual */ _soft_body_get_state(
      body: RID,
      state: PhysicsServer3D.BodyState,
    ): any;
    ...
    /* gdvirtual */ _soft_body_move_point(
      body: RID,
      point_index: int64,
      global_position: Vector3,
    ): void;
    /* gdvirtual */ _soft_body_get_point_global_position(
      body: RID,
      point_index: int64,
    ): Vector3;
    /* gdvirtual */ _soft_body_remove_all_pinned_points(body: RID): void;
    /* gdvirtual */ _soft_body_pin_point(
      body: RID,
      point_index: int64,
      pin: boolean,
    ): void;
    /* gdvirtual */ _soft_body_is_point_pinned(
      body: RID,
      point_index: int64,
    ): boolean;
    /* gdvirtual */ _soft_body_apply_point_impulse(
      body: RID,
      point_index: int64,
      impulse: Vector3,
    ): void;
    /* gdvirtual */ _soft_body_apply_point_force(
      body: RID,
      point_index: int64,
      force: Vector3,
    ): void;
    /* gdvirtual */ _soft_body_apply_central_impulse(
      body: RID,
      impulse: Vector3,
    ): void;
    /* gdvirtual */ _soft_body_apply_central_force(
      body: RID,
      force: Vector3,
    ): void;
    /* gdvirtual */ _joint_create(): RID;
    ...
    /* gdvirtual */ _joint_make_hinge_simple(
      joint: RID,
      body_A: RID,
      pivot_A: Vector3,
      axis_A: Vector3,
    ...
    /* gdvirtual */ _hinge_joint_set_param(
      joint: RID,
      param: PhysicsServer3D.HingeJointParam,
      value: float64,
    ): void;
    /* gdvirtual */ _hinge_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.HingeJointParam,
    ): float64;
    /* gdvirtual */ _hinge_joint_set_flag(
      joint: RID,
      flag: PhysicsServer3D.HingeJointFlag,
      enabled: boolean,
    ): void;
    /* gdvirtual */ _hinge_joint_get_flag(
      joint: RID,
      flag: PhysicsServer3D.HingeJointFlag,
    ): boolean;
    /* gdvirtual */ _joint_make_slider(
      joint: RID,
      body_A: RID,
    ...
    /* gdvirtual */ _slider_joint_set_param(
      joint: RID,
      param: PhysicsServer3D.SliderJointParam,
      value: float64,
    ): void;
    /* gdvirtual */ _slider_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.SliderJointParam,
    ): float64;
    /* gdvirtual */ _joint_make_cone_twist(
      joint: RID,
      body_A: RID,
      local_ref_A: Transform3D,
      body_B: RID,
    ...
    /* gdvirtual */ _cone_twist_joint_set_param(
      joint: RID,
      param: PhysicsServer3D.ConeTwistJointParam,
      value: float64,
    ): void;
    /* gdvirtual */ _cone_twist_joint_get_param(
      joint: RID,
      param: PhysicsServer3D.ConeTwistJointParam,
    ): float64;
    /* gdvirtual */ _joint_make_generic_6dof(
      joint: RID,
      body_A: RID,
      local_ref_A: Transform3D,
      body_B: RID,
    ...
    /* gdvirtual */ _generic_6dof_joint_set_param(
      joint: RID,
      axis: Vector3.Axis,
      param: PhysicsServer3D.G6DOFJointAxisParam,
      value: float64,
    ): void;
    /* gdvirtual */ _generic_6dof_joint_get_param(
      joint: RID,
      axis: Vector3.Axis,
      param: PhysicsServer3D.G6DOFJointAxisParam,
    ): float64;
    /* gdvirtual */ _generic_6dof_joint_set_flag(
      joint: RID,
      axis: Vector3.Axis,
      flag: PhysicsServer3D.G6DOFJointAxisFlag,
      enable: boolean,
    ): void;
    /* gdvirtual */ _generic_6dof_joint_get_flag(
      joint: RID,
      axis: Vector3.Axis,
      flag: PhysicsServer3D.G6DOFJointAxisFlag,
    ): boolean;
    /* gdvirtual */ _joint_get_type(joint: RID): PhysicsServer3D.JointType;
    /* gdvirtual */ _joint_set_solver_priority(
      joint: RID,
      priority: int64,
    ): void;
    ...
    /* gdvirtual */ _is_flushing_queries(): boolean;
    /* gdvirtual */ _get_process_info(
      process_info: PhysicsServer3D.ProcessInfo,
    ): int64;
    body_test_motion_is_excluding_body(body: RID): boolean;
    body_test_motion_is_excluding_object(object: int64): boolean;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsServer3DRenderingServerHandler
    extends __NameMapObject {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsShapeQueryParameters2D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsShapeQueryParameters3D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsTestMotionParameters2D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPhysicsTestMotionParameters3D
    extends __NameMapRefCounted {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPlaceholderCubemap
    extends __NameMapPlaceholderTextureLayered {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPlaceholderCubemapArray
    extends __NameMapPlaceholderTextureLayered {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPlaceholderTexture2DArray
    extends __NameMapPlaceholderTextureLayered {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapPlaceholderTextureLayered
    extends __NameMapTextureLayered {}
  /** Placeholder class for a 2-dimensional texture array.
   *
  ...
  class PolygonPathFinder extends Resource {
    ...
    setup(
      ...
      connections: PackedInt32Array | int32[],
    ): void;
  ...
  class PortableCompressedTexture2D extends Texture2D {
    ...
    create_from_image(
      ...
      normal_map?: boolean /* = false */,
      lossy_quality?: float64 /* = 0.8 */,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapRDPipelineColorBlendStateAttachment
    extends __NameMapRefCounted {}
