...
declare module "godot" {
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackInteractive
    extends __NameMapAudioStreamPlayback {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackOggVorbis
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackPlaylist
    extends __NameMapAudioStreamPlayback {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackPolyphonic
    extends __NameMapAudioStreamPlayback {}
  ...
  class AudioStreamPlaybackPolyphonic extends AudioStreamPlayback {
    ...
    play_stream(
      ...
      volume_db?: float64 /* = 0 */,
      pitch_scale?: float64 /* = 1 */,
      playback_type?: AudioServer.PlaybackType /* = 0 */,
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackResampled
    extends __NameMapAudioStreamPlayback {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapAudioStreamPlaybackSynchronized
    extends __NameMapAudioStreamPlayback {}
  ...
  class CPUParticles2D<Map extends NodePathMap = any> extends Node2D<Map> {
    ...
    set_particle_flag(
      particle_flag: CPUParticles2D.ParticleFlags,
      enable: boolean,
    ): void;
  ...
  > extends GeometryInstance3D<Map> {
    ...
    /** Enables or disables the given particle flag. */
    set_particle_flag(
      particle_flag: CPUParticles3D.ParticleFlags,
      enable: boolean,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCameraAttributesPhysical
    extends __NameMapCameraAttributes {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCameraAttributesPractical
    extends __NameMapCameraAttributes {}
  ...
  class CodeEdit<Map extends NodePathMap = any> extends TextEdit<Map> {
     ...
     */
    /* gdvirtual */ _filter_code_completion_candidates(
      candidates: GArray<GDictionary>,
    ): GArray<GDictionary>;
    ...
    add_code_completion_option(
      ...
      display_text: string,
      insert_text: string,
      text_color?: Color /* = new Color(1, 1, 1, 1) */,
    ...
    readonly symbol_lookup: Signal<
      (symbol: string, line: int64, column: int64) => void
    >;
     ...
     */
    readonly symbol_hovered: Signal<
      (symbol: string, line: int64, column: int64) => void
    >;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class CollisionObject2D<Map extends NodePathMap = any> extends Node2D<Map> {
    ...
    readonly input_event: Signal<
      (viewport: Node, event: InputEvent, shape_idx: int64) => void
    >;
  ...
  class CompositorEffect extends Resource {
    ...
    /* gdvirtual */ _render_callback(
      effect_callback_type: int64,
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCompressedCubemap
    extends __NameMapCompressedTextureLayered {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCompressedCubemapArray
    extends __NameMapCompressedTextureLayered {}
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCompressedTexture2DArray
    extends __NameMapCompressedTextureLayered {}
  ...
  class Control<Map extends NodePathMap = any> extends CanvasItem<Map> {
     ...
     */
    /* gdvirtual */ _structured_text_parser(
      args: GArray,
      text: string,
    ): GArray<Vector3i>;
    ...
    set_offsets_preset(
      preset: Control.LayoutPreset,
      resize_mode?: Control.LayoutPresetMode /* = 0 */,
      margin?: int64 /* = 0 */,
    ): void;
    ...
    set_anchor(
      side: Side,
      anchor: float64,
      keep_offset?: boolean /* = false */,
      push_opposite_anchor?: boolean /* = true */,
    ): void;
    ...
    set_anchor_and_offset(
      ...
      anchor: float64,
      offset: float64,
      push_opposite_anchor?: boolean /* = false */,
    ): void;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapConvertTransformModifier3D
    extends __NameMapBoneConstraint3D {}
  ...
  > extends BoneConstraint3D<Map> {
    ...
    set_apply_transform_mode(
      index: int64,
      transform_mode: ConvertTransformModifier3D.TransformMode,
    ): void;

    /** Returns the operation of the remapping destination transform. */
    get_apply_transform_mode(
      index: int64,
    ): ConvertTransformModifier3D.TransformMode;
  ...
  /** @deprecated Internal use. Does not exist at runtime. */
  interface __NameMapCopyTransformModifier3D
    extends __NameMapBoneConstraint3D {}
  ...
  > extends BoneConstraint3D<Map> {
    ...
    set_copy_flags(
      index: int64,
      copy_flags: CopyTransformModifier3D.TransformFlag,
    ): void;
    ...
    set_axis_flags(
      index: int64,
      axis_flags: CopyTransformModifier3D.AxisFlag,
    ): void;
  ...
  class Crypto extends RefCounted {
    ...
    verify(
      hash_type: HashingContext.HashType,
      hash: PackedByteArray | byte[] | ArrayBuffer,
      signature: PackedByteArray | byte[] | ArrayBuffer,
      key: CryptoKey,
    ): boolean;
    ...
    encrypt(
      key: CryptoKey,
      plaintext: PackedByteArray | byte[] | ArrayBuffer,
    ): PackedByteArray;
    ...
    decrypt(
      key: CryptoKey,
      ciphertext: PackedByteArray | byte[] | ArrayBuffer,
    ): PackedByteArray;
    ...
    hmac_digest(
      hash_type: HashingContext.HashType,
      key: PackedByteArray | byte[] | ArrayBuffer,
      msg: PackedByteArray | byte[] | ArrayBuffer,
    ): PackedByteArray;
    ...
    constant_time_compare(
      trusted: PackedByteArray | byte[] | ArrayBuffer,
      received: PackedByteArray | byte[] | ArrayBuffer,
    ): boolean;
    /** @deprecated Internal use. Does not exist at runtime. */
  ...
  class Curve extends Resource {
    ...
    add_point(
      position: Vector2,
      left_tangent?: float64 /* = 0 */,
      right_tangent?: float64 /* = 0 */,
      left_mode?: Curve.TangentMode /* = 0 */,
      right_mode?: Curve.TangentMode /* = 0 */,
    ): int64;
  ...
  class Curve2D extends Resource {
    ...
    add_point(
      position: Vector2,
      in_?: Vector2 /* = Vector2.ZERO */,
      out_?: Vector2 /* = Vector2.ZERO */,
      index?: int64 /* = -1 */,
    ): void;
