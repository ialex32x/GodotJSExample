declare module "godot-jsb" {
  ...
  function callable<
    S extends GObject,
    F extends (this: S, ...args: any[]) => any,
  >(self: S, fn: F): Callable<F>;
  ...
  export namespace internal {
    ...
    function add_script_property(
      prototype: GObject,
      details: ScriptPropertyInfo,
    ): void;
    ...
    function create_script_signal_getter(
      name: string,
    ): (this: GObject) => Signal;
    function create_script_cached_property_updater(
      name: string,
    ): (this: GObject, value?: unknown) => void;
    ...
    namespace names {
       ...
       */
      function get_variant_type<T extends string>(
        type: Variant.Type,
      ): StringName;
    }
  }
